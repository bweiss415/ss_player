import * as wasm from 'wasm_bid_lookup';
...
(function () {
    ...
    function Sb(a, b) {
        ...
        if (a.file)
            if ("string" === typeof a.file && eb(a.file)) delete a.file;
            else {
                var e = Ba(a.file);
                ...
                f ? (b && (delete f.watermarkLink, delete f.watermarkIcon, delete f.controls), (!a.advertising.sticky || "inBanner" !== a.type && "inPage" !== a.type) &&
                    delete f.stickyCloseButton, f.breakSchedule || (f.breakSchedule = e(f.adBreakSchedule)), delete f.adBreakSchedule, f.tag && (q.isArray(f.tag) || (f.tag = [f.tag]), f.tag.forEach(function (a, b) {
                        ...
                        }(), f.bestTimeout = Ra(f.bestTimeout, 2E3), f.requestTimeout = f.requestTimeout ||
    ...
    function Oa(a, b, g, e, n, f, p) {
        ...
        d(/\$\$RANDOM_10\$\$/g, Math.floor(9E9 * Math.random() + 1E9),
            !0);
        d(/\$\$HEIGHT\$\$/g, b, !0);
        d(/\$\$WIDTH\$\$/g, g, !0);
    ...
    function Wa(a, b, g, e, n) {
        ...
        function p(d) {
            ...
            c = function (b) {
                ...
                } catch (E) {}(b = c[a + "Return"]) && b.callId === l && e(b.returnValue, b.success)
            };
    ...
    function la(a) {
        ...
        if ("number" === typeof a) {
            ...
            typeof a && (a = document.getElementById(a)), gb(a), a) {
            for (var g in Ea)
                if ((b = Ea[g]) && b instanceof jb && b.getElement().parentElement === a) return b.getApi();
            b = new jb(function (a) {
    ...
    function jb(a, b, g, e) {
        ...
        var G = new function () {
            this.setup = function (b) {
                ...
                b = q.extend(!0, {}, b);
                if (!("mobile" === b.platform && !W || "desktop" === b.platform && W)) return Sb(b,
                        c.isAdapter()), l = b, A.prepare(l, c), a.innerHTML = "", "inView" !== b.type && "rewarded" !== b.type ? q(a).css({
                        display: "block",
                        overflow: "hidden"
                    }) : q(a).css("position", "absolute"), (E = "inStream" === b.type) || Ab(q(a)), b.advertising && (A.debugMode(b.advertising.debugMode), b.advertising.id = (new Date).getTime() + Math.random(), p(b)),
                    function () {
    ...
    function tc() {
        function a(a, b) {
            ...
            if (a !== x.adStarted) e.getApi().on(a,
                b);
            else {
                var f = 0;
    ...
    function uc(a, b, g) {
        function e(a, b, c) {
            var d;
            if (d = a ? b.requestFullscreen || b.webkitRequestFullscreen || b.mozRequestFullScreen || b.enterFullscreen || b.webkitEnterFullscreen || b.msRequestFullscreen : b.exitFullscreen ||
                b.webkitCancelFullScreen || b.webkitExitFullscreen || b.mozCancelFullScreen || b.msExitFullscreen) return void 0 === Fa && (Fa = !c),
                function () {
    ...
    function $b(a, b, g, e) {
        ...
        function f() {
            if (Aa(m, ".m3u8"))
                if (b.canPlayType("application/vnd.apple.mpegurl")) v =
                    function () {
        ...
        this.getBuffer = function () {
            ...
            if (a && a.length && b)
                for (var d = 0; d < a.length; d++)
                    if (c >= a.start(d) && c <= a.end(d)) return Math.min(100 * a.end(d) / b, 100);
            return 0
        };
        this.calcFit =
            function () {
                if (l.isFullscreen()) z.toggleClass("orp-fit-fill", !1);
                else {
                    try {
        ...
        (function () {
            ...
            q(b).on("volumechange", function () {
                ...
                m !== b.muted && (a = b.muted, c && localStorage.setItem(O("odPleyarPrA") + ".muted", a), m = b.muted,
                    d.trigger("mute", {
                        mute: m
                    }))
            })
    ...
    function rc(a, b) {
        ...
        var w, z, u, E, C, H, I, G, F, J, D = !1,
            B, N, L, K, Q = b.infoBar ? m(b.infoBarHeight) ||
            16 : 0,
            M = q(a),
        ...
        (function () {
            ...
            (a = b.advertising) && a.sticky && (u = m(a.stickyWidth), E = m(a.stickyHeight),
                L = m(a.stickyVerticalMargin), K = m(a.stickyHorizontalMargin), J = "orp-player-ivm-" + (a.position || "BR"));
            c();
            H = l();
            I = r();
            P.resize(g);
        ...
        this.stickyState = function (a) {
            ...
            a = F;
            N && (T.toggleClass("orp-js-positioned-sticky", a), a ? (setTimeout(d,
                0), P.on("scroll resize", d)) : (P.off("scroll resize", d), setTimeout(p, 100)));
            e(c || l(), m || r());
    ...
    function Xb(a, b, g) {
        ...
        this.build = function () {
            ...
            "inBanner" === b.type && (c.parent().addClass("orp-isInBanner"),
                b.inApp && c.parent().addClass("orp-isInApp"));
                ...
                events: {
                    onReady: function () {
                        ...
                        0 === n.getDuration() ? e("yt duration is 0") : (n.addEventListener("onStateChange", function (c) {
                            ...
                            w = !1;
                            p || !W && c.data !== g.PlayerState.PLAYING ? c.data === g.PlayerState.PLAYING ? d() : c.data === g.PlayerState.PAUSED ?
    ...
    function zc(a, b, g, e) {
        ...
        a.one(x.beforePlay, function () {
            ...
            f.forEach(function (a, d) {
                ...
                a.image && l.find(".orp-c-playlist-it-poster").css("background-image",
                    "url(" + a.image + ")").attr("alt", a.title);
    ...
    function Bc(a, b, g) {
        ...
        function m() {
            function b(a) {
                0 > a && (a = 0);
                var b = a;
                .5 < b ? c.removeClass("orp-vol-mid orp-vol-off") : 0 === b ? c.removeClass("orp-vol-mid").addClass("orp-vol-off") :
                    c.removeClass("orp-vol-off").addClass("orp-vol-mid");
                d.width(100 * a + "%")
            }
            var c = C(".orp-c-vol"),
                d = C(".orp-c-vol-curr"),
        ...
        var H = !1,
            ...
            J = !0;
        q(G).append(q('\x3cdiv class\x3d"orp-control orp-tap-unmute" style\x3d"display: none"\x3e' + O("$$$Tap to unmute$$$") + '\x3c/div\x3e\x3cdiv class\x3d"orp-control orp-more" style\x3d"display: none"\x3e' + O("$$$Learn more$$$") + '\x3c/div\x3e\x3cdiv class\x3d"orp-control orp-skip" style\x3d"display: none"\x3e\x3c/div\x3e\x3cdiv class\x3d"orp-control orp-close-bg" style\x3d"display: none;"\x3e\x3c/div\x3e\x3cdiv class\x3d"orp-control orp-close" style\x3d"display: none"\x3e\x3c/div\x3e' +
        ...
        this.init = function (c) {
            ...
            z();
            E(c.tag.socialLinks);
            g || (I = a.isYa() || a.isVpaid() || a.isYt(), I || (b.barColor && B.css("background-color",
                b.barColor), D.show()));
            ...
            g || pa.show();
            g || a.isYa() || (b.tapToUnmute && a.adVideoType() && (!a.volumeChanged() || J) && a.isMuted() && aa.show(), a.adVideoType() && M.show(), b.controls && a.isIma() && (Ga.show(), M.hide(), G.addClass("orp-isControlsDisplay"), !Fa && "rewarded" !== b.type && sa.show(), W || Hb || G.addClass("orp-isHiddenControls"),
    ...
    function Zb(a, b, g, e) {
        function n() {
            ...
            if (Q.tryReplayAd()) Q.isShown() && (e(!0), H());
            else if (B.isUserClose() || T) H(), z();
            else {
                var c = Q.isMidRoll();
                if (!a.inStream() && !c) {
                    B.forceFile(!!b.src() &&
                        (g.forceFile || Q.isAdStartedLoop() && P));
                    if (!B.forceFile()) {
                        z();
                        return
                    }
        ...
        function d() {
            ...
            if (g.advertising[O("iu")]) B.onAddImpression(l);
            else B.onAdStarted(l);
            B.onAdSkipped(r);
            B.onAdCompleted(r);
        ...
        this.build = function (c) {
            g.advertising && g.advertising.tag && g.advertising.tag.length ?
                (ta = g.advertising.lifecycleLoop || 0, Za.prepare(g.advertising), g.file && !a.inStream() && (g.autoStart && b.preload("none"), b.src(ja(g.file))), G = c(I, !1), b.on(x.beforePlay, u), v(), w(), B = new Gb(G, b, g.advertising.creativeTimeout), L = new Fb(B.getPlayerListeners()), B.setAdTracker(L), c = g.advertising ? q.extend({}, {
                    tapToUnmute: g.tapToUnmute,
                    type: g.type
                }, g.advertising) : {}, N = new Bc(B, c, a.isAdapter()), K = new Cc(B), Q = new Dc(a, b, G, B, n, g, f), M = new Ec(c), d()) : (B = new Gb(G, b, null), L = new Fb(B.getPlayerListeners()), B.setAdTracker(L),
                    b.on(x.beforePlay, f), b.one(x.beforeComplete, B.globalStop));
            m();
            return B
        }
    }
    ...
    function Dc(a, b, g, e, n, f, p) {
        function d(c) {
            ...
            N = !1;
            if (0 === d().tag.length) var n = !1;
            else G = new Fc(function (a) {
        ...
        function w(c) {
            return function () {
                if (!b.isError() && !a.d())
                    if (A.log("call start"), x || P || b.ended() || !b.isPaused() || N) c();
                    else b.one("play", c)
            }
        }
        ...
        function u(a) {
            E();
            f.advertising && f.advertising.tag.length && (K =
                C(a), f.advertising.tag.forEach(function (a) {
                    delete a.shown
                }));
            P = !1
        }
    ...
    function Lc(a, b, g, e, n) {
        ...
        function p() {
            (function (a) {
                ...
                function m() {
                    "function" ===
                    typeof p && z.off("fullscreenChange", p);
                    f()
                }
                if (void 0 !== a) {
                    var l = !1,
        ...
        function d() {
            ...
            if (e.icons && e.icons.length) {
                var b = e.icons[0],
                    d = ~~b.offset,
                    f = ~~b.duration,
                    m, l = new Ha.iconTracker(g, b),
                    n = function () {
                        l.setProgress(z.currentTime());
                        null === m &&
                            (-1 === d || z.currentTime() >= d) && (m = a(), -1 === f && z.off("timeupdate", n));
        ...
        this.init = function (c,
            ...
            z = c;
            u = r(g, e);
            if (void 0 === u) n.onAdError(403, g.errorURLTemplates);
            else if (b.adVideoType(C), u.src = ja(u.src), u.fileURL = ja(u.fileURL), w(u)) {
                E.tag._isVpaid = !0;
                z = v(u.src);
                try {
                    Mc(a, z, E, n).init(u, e)
    ...
    function nb(a, b) {
        ...
        function c() {
            ...
            return a(v.preRoll) ? v.preRoll : a(v.midRoll) ? v.midRoll : a(v.postRoll) ? v.postRoll :
                null
        }
    ...
    function Eb(a) {
        ...
        this.showDefaultTag = function (b) {
            ...
            Oa(c, u.sizeController().height(), u.sizeController().width(), m.appParams, a.getElement(), m.advertising, function (a) {
                v = l.createStub();
                d ?
                    v.after(a.replace("$$insertOutOfPlayer$$", "")) : (v.html(a), b && (a = q('\x3cdiv class\x3d"orp-close"\x3e\x3c/div\x3e'), v.append(a), a.click(function () {
        ...
        this.createStub = function () {
            ...
            u.sizeController().getAspectRatio() && b.append(q("\x3cdiv\x3e\x3c/div\x3e").css("paddingBottom",
                100 * u.sizeController().getAspectRatio() + "%"));
            v.replaceWith(b);
            a.destroy();
            return v = b
        };
    ...
    function Fc(a, b, g, e, n) {
        ...
        function v() {
            ...
            q(H).each(function (c, d) {
                if (d)
                    if (a++, d && !d.ok) c === x && x++;
                    else if (H[0] || F || c === x) return I = u(d), b(I.client), !1
            });
            I && I.ok || a !== E || (I = !0, g())
        }
    ...
    function Sc(a, b, g) {
        ...
        var p, d = g.getAdTracker();
        (function () {
            function b() {
                var b = a.getCurrentAd().getContentType();
                return b && (0 === b.indexOf("text") ||
                    0 === b.indexOf("image"))
            }
            ...
            e(google.ima.AdEvent.Type.CLICK,
                d.onAdClickThru);
    ...
    function Gc(a, b, g, e) {
        function n(c) {
            ...
            l.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,
                f);
    ...
    function Tc(a, b, g) {
        ...
        (function () {
            ...
            e("AdPodVideoThirdQuartile",
                a(75));
            e("AdUserClose", p.onAdUserClose);
            e("AllAdPodVideoComplete", p.onAdCompleted);
            e("AdPlayingStateChange", function (a) {
                if (f)
                    if ("play" === a.playingState) p.onAdPlaying();
                    else if ("pause" === a.playingState) p.onAdPaused()
            });
            ...
            var e = {
                ...
                f = function (b) {
                    if (b && b.data && "string" === typeof b.data) {
                        ...
                        "PPCP:prebidResponse" === d.command && d.messageId === e.messageId && (m && clearTimeout(m), window.removeEventListener("message", f), A.log(d), d.url && "failed" !==
        ...
        function n(n) {
            ...
            c.addEventListener(p.EVENT_REQUEST_COMPLETE, function (d) {
                if (d.success && null !== c) {
                    ...
                    if (l[0]) a.setAdPlayerWrapper(new Uc(p,
                        c, l[0], b, a, e)), n();
                    else r.onAdError("empty tags", void 0)
    ...
    function Vc(a, b, g, e, n) {
        var f = this,
            p = !0,
            d, c, l, r, m, q, w, z = e.getAdTracker();
        (function () {
            z.onAdLoaded();
    ...
    function Kc(a, b, g, e) {
        ...
        var c, l, r = "orp-yt-player-id-" + Math.random(),
            m = a.getAdTracker();
        this.isYt = !0;
        this.getOptions = function () {
            return e
    ...
    var q = function (a, b) {
            ...
            function w(a, b, c) {
                ...
                if (void 0 === c && 1 === a.nodeType)
                    if (k = "data-" + b.replace(db, "-$\x26").toLowerCase(), c = a.getAttribute(k), "string" == typeof c) {
                        try {
            ...
            function u(a, b) {
                for (var k, c, t = [], d = 0, e = a.length; d < e; d++)
                    if (c = a[d], c.style)
                        if (k = c.style.display, b) {
                            if ("none" === k && (t[d] = S.get(c, "display") || null, t[d] || (c.style.display = "")), "" === c.style.display && Jb(c)) {
                                k = d;
                                var f = void 0;
                                var g = c.ownerDocument;
                                var l = c.nodeName;
                                g = (c = Ra[l]) ? c : (f = g.body.appendChild(g.createElement(l)),
                                    c = h.css(f, "display"), f.parentNode.removeChild(f), "none" === c && (c = "block"), Ra[l] = c, c);
                                t[k] = g
                            }
            ...
            function A(a, b, c, d, e) {
                for (var k, t, y, R, f = b.createDocumentFragment(), g = [], ba = 0, l = a.length; ba < l; ba++)
                    if (k = a[ba], k || 0 === k)
                ...
                for (ba = 0; k = g[ba++];)
                    if (d &&
                        -1 < h.inArray(k, d)) e && e.push(k);
                    else if (R = h.contains(k.ownerDocument, k), t = E(f.appendChild(k), "script"), R && C(t), c)
                    for (y = 0; k = t[y++];) Wa.test(k.type || "") && c.push(k);
                return f
            }
            ...
            function J(a, b, c, d, e, f) {
                ...
                if (null == d && null == e ? (e = c, d = c = void 0) : null == e && ("string" == typeof c ? (e = d, d = void 0) : (e = d, d = c, c = void 0)), !1 ===
                    e) e = G;
                else if (!e) return a;
            ...
            function L(a, b) {
                ...
                if (1 === b.nodeType) {
                    if (S.hasData(a) &&
                        (k = S.access(a), c = S.set(b, k), f = k.events))
                        for (t in delete c.handle, c.events = {}, f)
                            for (k = 0, c = f[t].length; k < c; k++) h.event.add(b, t, f[t][k]);
            ...
            function K(a, b, c, d) {
                ...
                if (R && (k = A(b, a[0].ownerDocument, !1, a, d), t = k.firstChild, 1 === k.childNodes.length &&
                        (k = t), t || d)) {
                    ...
                    if (y)
                        for (k = t[t.length - 1].ownerDocument, h.map(t, N), e = 0; e < y; e++) m = t[e], Wa.test(m.type || "") && !S.access(m, "globalEval") && h.contains(k, m) && (m.src ? h._evalUrl && h._evalUrl(m.src) : g(m.textContent.replace(zb, ""), k))
                }
                return a
            }
            ...
            function Q(a, b, c) {
                for (var k = b ? h.filter(b, a) : a, t = 0; null != (b = k[t]); t++) c || 1 !== b.nodeType || h.cleanData(E(b)), b.parentNode && (c && h.contains(b.ownerDocument,
                    b) && C(E(b, "script")), b.parentNode.removeChild(b));
                return a
            }

            function M(a, b, c) {
                var k, t, d, y, e = a.style;
            ...
            function V(a) {
                ...
                if (!b) {
                    ...
                    a: {
                        var k = a;
                        if (!(k in ib)) {
                            for (var c = k[0].toUpperCase() + k.slice(1), d = hb.length; d--;)
                                if (k = hb[d] + c, k in ib) break a;
                            k = void 0
                        }
                    }
                    b = b[a] = k || a
            ...
            function ta(a, b, c, d, e) {
                var k = 0;
                for (b = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0; 4 > b; b += 2) "margin" === c && (k += h.css(a, c + Ka[b], !0, e)), d ? ("content" === c && (k -= h.css(a, "padding" + Ka[b], !0, e)), "margin" !== c && (k -= h.css(a, "border" + Ka[b] + "Width", !0, e))) : (k +=
                    h.css(a, "padding" + Ka[b], !0, e), "padding" !== c && (k += h.css(a, "border" + Ka[b] + "Width", !0, e)));
                return k
            }
            ...
            function ra(a, b, c) {
                for (var k, d = (W.tweeners[b] || []).concat(W.tweeners["*"]), t = 0, h = d.length; t < h; t++)
                    if (k = d[t].call(c, b, a)) return k
            }

            function Z(a, b) {
                var k, c, d, t, e;
                for (k in a)
                    if (c = h.camelCase(k), d = b[c], t = a[k], Array.isArray(t) && (d = t[1], t = a[k] = t[0]), k !== c && (a[c] =
                            t, delete a[k]), e = h.cssHooks[c], e && "expand" in e)
                        for (k in t = e.expand(t), delete a[c], t) k in a || (a[k] = t[k], b[k] = d);
                    else b[c] = d
            }
            ...
            function W(a, b, c) {
                ...
                c = f.props;
                for (Z(c, f.opts.specialEasing); d <
                    t; d++)
                    if (b = W.prefilters[d].call(f, a, c, f.opts)) return h.isFunction(b.stop) && (h._queueHooks(f.elem, f.opts.queue).stop = h.proxy(b.stop, b)), b;
            ...
            function Mb(a) {
                return function (b, k) {
                    ...
                    if (h.isFunction(k))
                        for (; c = t[d++];) "+" === c[0] ? (c = c.slice(1) || "*", (a[c] = a[c] || []).unshift(k)) : (a[c] = a[c] || []).push(k)
                }
            }
                ...
                map: function (a, b, c) {
                    ...
                    if (e(a))
                        for (k = a.length; d < k; d++) {
                            ...
                            for (d in a) h = b(a[d], d, c), null != h && t.push(h);
                    return la.apply([], t)
                },
                guid: 1,
                proxy: function (a, b) {
            ...
            var Ma = function (a) {
                function b(a, b, c, k) {
                    var d, t, e, h, f = b && b.ownerDocument,
                        y = b ? b.nodeType : 9;
                ...
                function u(a, b, c) {
                    ...
                    return b.first ? function (b, c, d) {
                        for (; b = b[k];)
                            if (1 === b.nodeType || e) return a(b, c, d);
                        return !1
                    } : function (b, c, f) {
                        var y, g, l, n = [I, h];
                        if (f)
                            for (; b = b[k];) {
                                ...
                                for (; b = b[k];)
                                    if (1 === b.nodeType || e)
                                        if (l = b[L] || (b[L] = {}), g = l[b.uniqueID] || (l[b.uniqueID] = {}), d && d === b.nodeName.toLowerCase()) b = b[k] || b;
                                        else {
                ...
                function B(a) {
                    ...
                    for (var e = d ? 1 : 0, h = u(function (a) {
                        ...
                        if (t = Y.relative[a[e].type]) y = [u(q(y), t)];
                        else {
                    ...
                    var d = 0 < c.length,
                        ...
                        e = function (k, e, h, f, y) {
                            var g, l, n = 0,
                                ...
                                r = k || t && Y.find.TAG("*", y),
                                Ja = I +=
                                null == ba ? 1 : Math.random() || .1,
                                ab = r.length;
                            for (y && (K = e === D || e || y); m !== ab && null != (g = r[m]); m++) {
                                if (t && g) {
                                    var u = 0;
                                    for (e || g.ownerDocument === D || (ia(g), h = !A); l = a[u++];)
                                        if (l(g, e || D, h)) {
                                            f.push(g);
                                            break
                                        } y && (I = Ja)
                ...
                var z, J, V, K, P, N, D, M, A, x, E, C, Q, L = "sizzle" + 1 * new Date,
                    T = a.document,
                    I = 0,
                    G = 0,
                    H = c(),
                ...
                var Y = b.selectors = {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (a) {
                            var b, c = !a[6] && a[2];
                            return La.CHILD.test(a[0]) ? null : (a[3] ? a[2] = a[4] || a[5] || "" : c &&
                                ...
                                function (b, c, f) {
                                    ...
                                    if (l) {
                                        if (t) {
                                            for (; c;) {
                                                for (y = b; y = y[c];)
                                                    if (h ? y.nodeName.toLowerCase() === n : 1 === y.nodeType) return !1;
                                        ...
                                        if (R = [e ? l.firstChild : l.lastChild], e && f) {
                                            ...
                                            var r = ba[a] || [];
                                            m = (g = r[0] === I && r[1]) && r[2];
                                            for (y = g && l.childNodes[g]; y = ++g && y && y[c] || (m = g = 0) || R.pop();)
                                                if (1 === y.nodeType &&
                                                    ++m && y === b) {
                                                    ba[a] = [I, g, m];
                                                    break
                                                }
                                        } else if (f && (y = b, p = y[L] || (y[L] = {}), ba = p[y.uniqueID] || (p[y.uniqueID] = {}), r = ba[a] || [], g = r[0] === I && r[1], m = g), !1 === m)
                                            for (;
                                                (y = ++g && y && y[c] || (m = g = 0) || R.pop()) && ((h ? y.nodeName.toLowerCase() !== n : 1 !== y.nodeType) || !++m || (f && (p = y[L] || (y[L] = {}), ba = p[y.uniqueID] || (p[y.uniqueID] = {}), ba[a] = [I, m]), y !== b)););
                                        return m -= d, m === k || 0 === m % k && 0 <= m / k
                                    }
                                }
                        },
                        PSEUDO: function (a, c) {
                            var d, t = Y.pseudos[a] || Y.setFilters[a.toLowerCase()] || b.error("unsupported pseudo: " + a);
                    ...
                    pseudos: {
                        ...
                        lang: k(function (a) {
                            return Mb.test(a || "") || b.error("unsupported lang: " + a), a = a.replace(da, fa).toLowerCase(),
                                function (b) {
                                    var c;
                                    do
                ...
                return J = b.compile = function (a, b) {
                    ...
                    if (c = c || [], 1 === g.length) {
                        ...
                        for (d = La.needsContext.test(a) ? 0 : t.length; d-- && (e = t[d], !Y.relative[h = e.type]);)
                            if ((f = Y.find[h]) && (k = f(e.matches[0].replace(da, fa), sb.test(t[0].type) && m(b.parentNode) || b))) {
                ...
                if (c = c || Qa, "string" == typeof a) {
                    ...
                    if (k[1]) {
                        if (b = b instanceof h ? b[0] : b, h.merge(this, h.parseHTML(k[1],
                                b && b.nodeType ? b.ownerDocument || b : X, !0)), Ca.test(k[1]) && h.isPlainObject(b))
            ...
            "complete" ===
            X.readyState || "loading" !== X.readyState && !X.documentElement.doScroll ? a.setTimeout(h.ready) : (X.addEventListener("DOMContentLoaded", m), a.addEventListener("load", m));
            var oa = function (a, b, c, d, e, f, g) {
                    var k = 0,
                        t = a.length,
                        y = null == c;
                    if ("object" === h.type(c))
                        for (k in e = !0, c) oa(a, b, k, c[k], !0, f, g);
                    else if (void 0 !== d && (e = !0, h.isFunction(d) || (g = !0), y && (g ? (b.call(a, d), b = null) : (y = b, b = function (a, b, c) {
                            return y.call(h(a), c)
                        })), b))
                        for (; k < t; k++) b(a[k], c, g ? d : d.call(a[k], k, b(a[k], c)));
            ...
            q.prototype = {
                ...
                remove: function (a, b) {
                    var c, k = a[this.expando];
                    if (void 0 !== k) {
                        if (void 0 !== b)
                            for (Array.isArray(b) ? b = b.map(h.camelCase) : (b = h.camelCase(b), b = b in k ? [b] : b.match(ma) || []), c = b.length; c--;) delete k[b[c]];
            ...
            h.extend({
                queue: function (a, b, c) {
                    var k;
                    if (a) return b = (b || "fx") + "queue", k = S.get(a, b), c && (!k || Array.isArray(c) ? k = S.access(a, b, h.makeArray(c)) :
                        k.push(c)), k || []
                },
            ...
            h.fn.extend({
                queue: function (a, b) {
                    ...
                    return "string" != typeof a && (b = a,
                        a = "fx", c--), arguments.length < c ? h.queue(this[0], a) : void 0 === b ? this : this.each(function () {
                ...
                promise: function (a, b) {
                    ...
                    for (a = a || "fx"; t--;)(c = S.get(e[t], a + "queueHooks")) &&
                        c.empty && (k++, c.empty.add(f));
            ...
            ! function () {
                ...
                a.innerHTML =
                    "\x3ctextarea\x3ex\x3c/textarea\x3e";
            ...
            h.event = {
                ...
                add: function (a, b, c, d, e) {
                    var k, t, f, g, y, l, m, n;
                    if (g = S.get(a))
                        for (c.handler && (k = c, c = k.handler, e = k.selector), e && h.find.matchesSelector(Pb, e), c.guid || (c.guid = h.guid++), (f = g.events) || (f = g.events = {}), (t = g.handle) || (t = g.handle = function (b) {
                            ...
                            R && (l = h.event.special[R] || {}, R = (e ? l.delegateType : l.bindType) || R, l = h.event.special[R] || {}, y = h.extend({
                                ...
                                namespace: p.join(".")
                            }, k), (m = f[R]) || (m = f[R] = [], m.delegateCount = 0, l.setup && !1 !== l.setup.call(a, d, p, t) || a.addEventListener && a.addEventListener(R,
                ...
                remove: function (a, b, c, d, e) {
                    var k, t, f, g, y, l, m, n, p = S.hasData(a) && S.get(a);
                    if (p && (g = p.events)) {
                        b = (b || "").match(ma) || [""];
                        for (y = b.length; y--;)
                            if (f = Za.exec(b[y]) || [], l = n = f[1], m = (f[2] || "").split(".").sort(), l) {
                                ...
                                for (l in g) h.event.remove(a, l + b[y], c, d, !0);
                ...
                dispatch: function (a) {
                    ...
                    if (b.delegateTarget = this, !l.preDispatch || !1 !== l.preDispatch.call(this, b)) {
                        ...
                        for (c = 0;
                            (d = m[c++]) && !b.isPropagationStopped();)
                            for (b.currentTarget = d.elem, g = 0;
                                (e = d.handlers[g++]) && !b.isImmediatePropagationStopped();) b.rnamespace && !b.rnamespace.test(e.namespace) || (b.handleObj = e, b.data = e.data, k = ((h.event.special[e.origType] || {}).handle || e.handler).apply(d.elem, f),
                                void 0 !== k && !1 === (b.result = k) && (b.preventDefault(), b.stopPropagation()));
            ...
            h.each({
                ...
                which: function (a) {
                    var b = a.button;
                    return null == a.which && kb.test(a.type) ? null != a.charCode ? a.charCode : a.keyCode :
                ...
                clone: function (a, b, c) {
                    ...
                    if (!(ca.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || h.isXMLDoc(a))) {
                        ...
                        for (d = t.length; g < d; g++) {
                            ...
                            "input" === n && Ta.test(l.type) ? m.checked = l.checked : "input" !== n && "textarea" !==
                                n || (m.defaultValue = l.defaultValue)
                        }
                    }
                    if (b)
                        if (c)
                            for (t = t || E(a), f = f || E(k), g = 0, d = t.length; g < d; g++) L(t[g], f[g]);
                        else L(a, k);
            ...
            h.fn.extend({
                ...
                replaceWith: function () {
                    ...
                    return K(this, arguments, function (b) {
                        ...
                        0 > h.inArray(this, a) && (h.cleanData(E(this)), c && c.replaceChild(b,
                            this))
                    }, a)
                }
            });
            ...
            ! function () {
                ...
                l.style && (l.style.backgroundClip = "content-box", l.cloneNode(!0).style.backgroundClip = "", ca.clearCloneStyle = "content-box" === l.style.backgroundClip,
                    g.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", g.appendChild(l), h.extend(ca, {
            ...
            h.extend({
                ...
                style: function (a, b, c, d) {
                    if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                        var k, e, f, t = h.camelCase(b),
                            g = fb.test(b),
                            l = a.style;
                        return g || (b = V(t)), f = h.cssHooks[b] || h.cssHooks[t], void 0 === c ? f && "get" in
                ...
                css: function (a, b, c, d) {
                    var k, e, f, g = h.camelCase(b);
                    return fb.test(b) || (b = V(g)), f = h.cssHooks[b] || h.cssHooks[g], f && "get" in f && (k = f.get(a, !0, c)), void 0 === k && (k = M(a, b, d)), "normal" ===
            ...
            h.cssHooks.marginLeft =
                T(ca.reliableMarginLeft, function (a, b) {
            ...
            h.Animation = h.extend(W, {
                ...
                prefilters: [function (a, b, c) {
                    var d, k, e, f, g, t, l, m, n = "width" in b || "height" in b,
                        p = this,
                        y = {},
                        r = a.style,
                        q = a.nodeType && Jb(a),
                        w = S.get(a, "fxshow");
                    c.queue || (f = h._queueHooks(a,
                    ...
                    for (d in b)
                        ...
                        } if (t = !h.isEmptyObject(b), t || !h.isEmptyObject(y))
                        for (d in n && 1 === a.nodeType && (c.overflow = [r.overflow, r.overflowX, r.overflowY], l = w && w.display,
                                null == l && (l = S.get(a, "display")), m = h.css(a, "display"), "none" === m && (l ? m = l : (u([a], !0), l = a.style.display || l, m = h.css(a, "display"), u([a]))), ("inline" === m || "inline-block" === m && null != l) && "none" === h.css(a, "float") && (t || (p.done(function () {
                                    r.display = l
            ...
            h.speed = function (a, b, c) {
                ...
                return h.fx.off ? d.duration = 0 : "number" != typeof d.duration && (d.duration in h.fx.speeds ?
                    d.duration = h.fx.speeds[d.duration] : d.duration = h.fx.speeds._default), null != d.queue && !0 !== d.queue || (d.queue = "fx"), d.old = d.complete, d.complete = function () {
                ...
                stop: function (a, b, c) {
                    ...
                    return "string" != typeof a && (c = b, b = a, a = void 0), b && !1 !== a && this.queue(a || "fx", []), this.each(function () {
                        ...
                        if (k) f[k] && f[k].stop && d(f[k]);
                            ...
                            for (k in f) f[k] && f[k].stop && Db.test(k) && d(f[k]);
            ...
            h.extend({
                attr: function (a, b, c) {
                    ...
                    if (3 !== e && 8 !== e && 2 !== e) return "undefined" == typeof a.getAttribute ? h.prop(a, b, c) : (1 === e && h.isXMLDoc(a) || (k = h.attrHooks[b.toLowerCase()] || (h.expr.match.bool.test(b) ? Eb : void 0)), void 0 !== c ? null === c ? void h.removeAttr(a, b) : k && "set" in k && void 0 !== (d = k.set(a, c, b)) ? d : (a.setAttribute(b,
            ...
            h.extend({
                prop: function (a, b, c) {
                    var d, k, e = a.nodeType;
                    if (3 !== e && 8 !== e && 2 !== e) return 1 === e && h.isXMLDoc(a) || (b = h.propFix[b] || b, k = h.propHooks[b]), void 0 !==
            ...
            h.fn.extend({
                addClass: function (a) {
                    ...
                    if ("string" == typeof a && a)
                        for (b = a.match(ma) || []; c = this[g++];)
                            if (k = ua(c), d = 1 === c.nodeType && " " + qa(k) + " ") {
                                for (f = 0; e = b[f++];) 0 > d.indexOf(" " + e + " ") && (d += e + " ");
                                d = qa(d);
                                k !== d && c.setAttribute("class",
                                    d)
                            } return this
                },
                ...
                toggleClass: function (a, b) {
                    ...
                    return "boolean" == typeof b &&
                        "string" === c ? b ? this.addClass(a) : this.removeClass(a) : h.isFunction(a) ? this.each(function (c) {
                ...
                hasClass: function (a) {
                    ...
                    for (a = " " + a +
                        " "; b = this[c++];)
                        if (1 === b.nodeType && -1 < (" " + qa(ua(b)) + " ").indexOf(a)) return !0;
                    return !1
                }
            });
            var Hb = /\r/g;
                ...
                val: function (a) {
                    ...
                    if (arguments.length) return d = h.isFunction(a), this.each(function (c) {
                        ...
                        1 === this.nodeType && (e = d ? a.call(this, c, h(this).val()) : a, null == e ? e = "" : "number" == typeof e ? e += "" : Array.isArray(e) && (e = h.map(e, function (a) {
                            return null == a ? "" : a + ""
                        })), b = h.valHooks[this.type] || h.valHooks[this.nodeName.toLowerCase()], b && "set" in b && void 0 !== b.set(this, e, "value") || (this.value =
                            e))
                    });
                    ...
                    select: {
                        get: function (a) {
                            var b, c, d = a.options,
                                ...
                                f = k ? null : [],
                                g = k ? e + 1 : d.length;
                            for (c = 0 > e ? g : k ? e : 0; c < g; c++)
                                if (b = d[c], !(!b.selected && c !== e || b.disabled || b.parentNode.disabled &&
                                        n(b.parentNode, "optgroup"))) {
            ...
            h.extend(h.event, {
                trigger: function (b, c, d, e) {
                    ...
                    if (k = f = d = d || X, 3 !== d.nodeType && 8 !== d.nodeType && !mb.test(p + h.event.triggered) && (-1 < p.indexOf(".") && (t = p.split("."), p = t.shift(), t.sort()), g = 0 > p.indexOf(":") && "on" + p, b = b[h.expando] ? b : new h.Event(p, "object" == typeof b && b), b.isTrigger = e ? 2 : 3, b.namespace = t.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + t.join("\\.(?:.*\\.|)") +
                        ...
                        for (t = 0;
                            (k = n[t++]) && !b.isPropagationStopped();) b.type = 1 < t ? r : m.bindType || p, (l = (S.get(k, "events") || {})[b.type] && S.get(k, "handle")) && l.apply(k, c), (l = g && k[g]) &&
                            l.apply && Ob(k) && (b.result = l.apply(k, c), !1 === b.result && b.preventDefault());
                ...
                ajax: function (b, c) {
                    function d(b, c, d, f) {
                        ...
                        if (!P) {
                            ...
                            if (d) {
                                var B = p;
                                for (var z = v, D, V, K, x, M = B.contents, N = B.dataTypes;
                                    "*" === N[0];) N.shift(), void 0 === D && (D = B.mimeType || z.getResponseHeader("Content-Type"));
                                if (D)
                                    for (V in M)
                                        if (M[V] && M[V].test(D)) {
                                            N.unshift(V);
                            ...
                            a: {
                                d =
                                p;D = B;V = v;K = f;
                                var A, L, E;B = {};z = d.dataTypes.slice();
                                if (z[1])
                                    for (A in d.converters) B[A.toLowerCase()] = d.converters[A];
                                for (x = z.shift(); x;)
                                    if (d.responseFields[x] && (V[d.responseFields[x]] = D), !E && K && d.dataFilter && (D = d.dataFilter(D, d.dataType)), E = x, x = z.shift())
                                        if ("*" === x) x = E;
                                        else if ("*" !== E && E !== x) {
                                    if (A = B[E + " " + x] || B["* " + x], !A)
                                        for (C in B)
                                            if (L = C.split(" "), L[1] === x && (A = B[E + " " + L[0]] || B["* " + L[0]])) {
                    ...
                    c = c || {};
                    var e, k, f, g, l, m, n, p = h.ajaxSetup({}, c),
                        t = p.context || p,
                        ...
                        v = {
                            ...
                            getResponseHeader: function (a) {
                                ...
                                if (P) {
                                    if (!f)
                                        for (f = {}; b = Vb.exec(k);) f[b[1].toLowerCase()] = b[2];
                                    b = f[a.toLowerCase()]
                                }
                                return null ==
                                    b ? null : b
                ...
                if (ca.cors || wb && !b.crossDomain) return {
                    send: function (e, f) {
                        ...
                        if (h.open(b.type, b.url, b.async, b.username, b.password), b.xhrFields)
                            for (k in b.xhrFields) h[k] = b.xhrFields[k];
                        ...
                        c = function (a) {
                            return function () {
                                c &&
                                    (c = d = h.onload = h.onerror = h.onabort = h.onreadystatechange = null, "abort" === a ? h.abort() : "error" === a ? "number" != typeof h.status ? f(0, "error") : f(h.status, h.statusText) : f(Yb[h.status] || h.status, h.statusText, "text" !== (h.responseType || "text") || "string" != typeof h.responseText ? {
                                        binary: h.response
                                    } : {
                                        text: h.responseText
            ...
            h.ajaxPrefilter("json jsonp", function (b, c, d) {
                var e, f, k, g = !1 !== b.jsonp && (gc.test(b.url) ? "url" : "string" == typeof b.data && 0 ===
                    (b.contentType || "").indexOf("application/x-www-form-urlencoded") && gc.test(b.data) && "data");
            ...
            h.parseHTML = function (a, b, c) {
                ...
                var d, e, f;
                return b || (ca.createHTMLDocument ? (b = X.implementation.createHTMLDocument(""), d = b.createElement("base"), d.href =
            ...
            h.offset = {
                setOffset: function (a, b, c) {
                    ...
                    var n = h.css(a, "left");
                    ("absolute" ===
                        k || "fixed" === k) && -1 < (m + n).indexOf("auto") ? (d = g.position(), f = d.top, e = d.left) : (f = parseFloat(m) || 0, e = parseFloat(n) || 0);
                ...
                position: function () {
                    if (this[0]) {
                        ...
                        return "fixed" === h.css(c, "position") ? b = c.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), n(a[0], "html") || (d = a.offset()), d = {
                            ...
                            left: b.left - d.left - h.css(c, "marginLeft",
                                !0)
                        }
                    }
                },
                ...
                h.each({
                    ...
                    h.fn[d] = function (e, f) {
                        ...
                        return oa(this, function (b, c, e) {
                            var f;
                            return h.isWindow(b) ? 0 === d.indexOf("outer") ? b["inner" + a] : b.document.documentElement["client" + a] : 9 === b.nodeType ? (f =
    ...
    var Ia = /(Safari)/i.test(navigator.userAgent) &&
    ...
    var za = function () {
        ...
        Vb = function () {
            return function (a) {
                ...
                var b = RegExp(".cdn.ampproject.org(?:/.{1,4}){0,6}/(.*)",
                    "gi").exec(a);
        ...
        O = function (a) {
            if (!a) return a;
            if (5 < a.length && 0 === a.indexOf("$$$") && a.lastIndexOf("$$$") === a.length - 3) return a.substr(3,
                a.length - 6);
            a = a.split("");
        ...
        A = new function () {
            function a(a, d, f, l, p, m) {
                ...
                if (!u && (u = ~~d.ap, 1 >= u || a !== w && a !== C ? u = !1 : (q.ap = u, u = !(1 > Math.random() * u)), !u)) {
                    ...
                    n(q, d);
                    q.r = Math.random();
                    !d.sendEventsAsBatch || a !== C && a !== w && a !== r || xb.getStorage("ap.log", !1) ? M.length ? (M.push(q), g(), f = !0) : f = void 0 : (M.push(q), 100 <= M.length ? g() : T || (T = setTimeout(g,
                        d.sendEventsAsBatch)), f = !0);
                    f || b(l, q);
                    e(a, d)
                }
            }
                ...
                if (M.length) {
                    ...
                    q.ajax({
                        ...
                        success: function (c, d, e) {
                            200 === e.status &&
                                "image/gif" === e.getResponseHeader("content-type") && (a.forEach(function (a) {
                                    a.z = (a.z || "") + "sg:1;";
                                    b(U, a)
            ...
            this.initError = function (b, c, d) {
                var e = {};
                d ? e = d.advertising : e[fa] = O("Hpv_42oQSI7crqHe1Dwo8wpEu8VEw7KCBYGHKl8nzVxEWeyGiEaO") ||
                    b && (q(b).attr("data-id") || b.id) || "initError";
    ...
    (function () {
        function a(a, e) {
            if (a && e) {
                ...
                } else f = e.split("/"), d = parseInt(f[1]), d = (new Date((new Date).setHours((new Date).getHours() + d))).getTime(), (f = g(a, d, 1, f[0], "frequencyCapping create")) && localStorage.setItem(a,
        ...
        Sa = function (a, f) {
            function g(a, c) {
                ...
                return !d || d.counterShowed < d.frequency ?
    ...
    la.push = function (a) {
        ...
        function n(a, b, e) {
            ...
            return "inView" === e || "rewarded" === e ? b.parent.document.body : b.frameElement ||
                a
        }
        ...
        return function n(b, g, e) {
            ...
            1: [function (b, g, e) {
                ...
                n.prototype.setMaxListeners = function (b) {
                    if ("number" !==
                        typeof b || 0 > b || isNaN(b)) throw TypeError("n must be a positive number");
                ...
                n.prototype.addListener = function (b, c) {
                    ...
                    this._events[b] ? p(this._events[b]) ?
                        this._events[b].push(c) : this._events[b] = [this._events[b], c] : this._events[b] = c;
                ...
                n.prototype.removeListener = function (b, c) {
                    ...
                    var e = d.length;
                    var g = -1;
                    if (d === c || f(d.listener) && d.listener === c) delete this._events[b], this._events.removeListener &&
                ...
                n.prototype.removeAllListeners = function (b) {
                    ...
                    if (f(c)) this.removeListener(b, c);
                        ...
                        for (; c.length;) this.removeListener(b, c[c.length - 1]);
            ...
            3: [function (b, g, e) {
                ...
                b = function () {
                    ...
                    b.get = function (b, c, f) {
                        ...
                        if (this.cappingFreeLunch >= this.totalCalls) f(null, Error("VAST call canceled \ufffd\ufffd\ufffd FreeLunch capping not reached yet " + this.totalCalls + "/" + this.cappingFreeLunch));
                        else {
                            c = d - this.lastSuccessfullAd;
                            if (0 >
                                c) this.lastSuccessfullAd = 0;
                ...
                b = function () {
                    ...
                    b._parse = function (b, c, d, g) {
                        function l(b, c) {
                            ...
                            c.ads.forEach(function (c) {
                                -1 === b.ads.indexOf(c) &&
                                    (b.ads.push(c), b._forEvents.push(c));
                            ...
                            return function (f, m) {
                                ...
                                for (B = r.ads.length; B--;) v = r.ads[B], null != v.nextWrapperURL && function (f) {
                                    ...
                                    if (5 <= c.length || (g = f.nextWrapperURL, 0 <= n.call(c, g))) e.track(f.errorURLTemplates, {
                                        ERRORCODE: 302
                                    }), r.ads.splice(r.ads.indexOf(f), 1), z();
                                    else return 0 === f.nextWrapperURL.indexOf("//") ? (g = location.protocol, f.nextWrapperURL = "" + g + f.nextWrapperURL) : -1 === f.nextWrapperURL.indexOf("://") && (g = b.slice(0, b.lastIndexOf("/")), f.nextWrapperURL = g + "/" + f.nextWrapperURL), e._parse(f.nextWrapperURL,
                                        c, d,
                                        function (b, c) {
                                            var d, g, m, p;
                                            var n = !1;
                                            if (null != b) e.track(f.errorURLTemplates, {
                                                ERRORCODE: 301
                                            }), r.ads.splice(r.ads.indexOf(f), 1), n = !0;
                                                ...
                                                for (g = q.length; w < g; w++) {
                                                    ...
                                                    if (null != f.videoClickTrackingURLTemplates)
                                                        for (p = u.creatives, m = 0, K = p.length; m < K; m++) F = p[m], "linear" === F.type && (F.videoClickTrackingURLTemplates =
                                                            F.videoClickTrackingURLTemplates.concat(f.videoClickTrackingURLTemplates));
                                                    if (null != f.videoCustomClickURLTemplates)
                                                        for (p = u.creatives, m = 0, K = p.length; m < K; m++) F = p[m], "linear" === F.type && (F.videoCustomClickURLTemplates = F.videoCustomClickURLTemplates.concat(f.videoCustomClickURLTemplates));
                                                    if (null != f.videoClickThroughURLTemplate)
                                                        for (m = u.creatives, K = 0, u = m.length; K < u; K++) F = m[K], "linear" === F.type && null == F.videoClickThroughURLTemplate && (F.videoClickThroughURLTemplate = f.videoClickThroughURLTemplate)
                                                }
                                            }
                    ...
                    b.parseAdElement = function (b) {
                        ...
                        for (c = e.length; f < c; f++) {
                            ...
                            if ("Wrapper" === (d = g.nodeName) || "InLine" === d) {
                                ...
                                this.copyNodeAttribute("sequence",
                                    b, g);
                    ...
                    b.parseWrapperElement = function (b) {
                        ...
                        for (d = e.length; b < d; b++) {
                            var f = e[b];
                            "linear" !== f.type && "nonlinear" !== f.type || null == f ||
                                ...
                                case "Creatives":
                                    ...
                                    for (e = p.length; l < e; l++) {
                                        ...
                                        for (f = q.length; n < f; n++) {
                                            ...
                                            switch (r.nodeName) {
                                                case "Linear":
                                                    (r = this.parseCreativeLinearElement(r)) &&
                                                    g.creatives.push(r);
                                                    break;
                                                case "NonLinearAds":
                    ...
                    b.parseCreativeLinearElement = function (b) {
                            ...
                            for (g = n.length; l < g; l++) {
                                ...
                                if (null != r && null != w) {
                                    if ("progress" === r) {
                                        ...
                                        if (!r) continue;
                                        r = "%" === r.charAt(r.length - 1) ? "progress-" + r : "progress-" +
                        ...
                        for (c = p.length; f < c; f++)
                            for (d = p[f], n = this.childsByName(d, "MediaFile"), g = 0, d = n.length; g < d; g++) w = n[g], l = new z, l.id = w.getAttribute("id"), l.fileURL = this.parseNodeText(w), l.deliveryType = w.getAttribute("delivery"), l.codec = w.getAttribute("codec"), l.mimeType = w.getAttribute("type"), l.apiFramework = w.getAttribute("apiFramework"), l.bitrate = parseInt(w.getAttribute("bitrate") ||
                        ...
                        if (null != b)
                            for (d = this.childsByName(b, "Icon"), p = 0, f = d.length; p < f; p++) {
                                c = d[p];
                                b = new u;
                                ...
                                if (null != l)
                                    for (b.iconClickThroughURLTemplate = this.parseNodeText(this.childByName(l, "IconClickThrough")), n = this.childsByName(l, "IconClickTracking"), w = 0, g = n.length; w < g; w++) l = n[w], b.iconClickTrackingURLTemplates.push(this.parseNodeText(l));
                    ...
                    b.parseCompanionAd = function (b) {
                        ...
                        for (d = l.length; m < d; m++) {
                            ...
                            q = 0;
                            for (r = e.length; q < r; q++) n = e[q], b.type =
                                n.getAttribute("creativeType") || 0, b.staticResource = this.parseNodeText(n);
                    ...
                    b.parseDuration = function (b) {
                        ...
                        d = parseInt(60 * c[1]);
                        c = parseInt(3600 * c[0]);
                        return isNaN(c || isNaN(d || isNaN(b || 3600 < d || 60 < b))) ? -1 : c + d +
                            b
                    };
            ...
            14: [function (b, g, e) {
                ...
                b = function (b) {
                    function e(b, d) {
                        ...
                        this.skipDelay = -1;
                        this.linear = !1;
                        this.creative instanceof c && (this.setDuration(this.creative.duration), this.skipDelay = this.creative.skipDelay || this.skipDelay, this.linear = !0, this.clickThroughURLTemplate =
                            this.creative.videoClickThroughURLTemplate, this.clickTrackingURLTemplates = this.creative.videoClickTrackingURLTemplates);
                    ...
                    e.prototype.setProgress = function (b) {
                        var c =
                            null === this.skipDelay ? this.skipDelayDefault : this.skipDelay; - 1 === c || this.skipable || (c > b ? this.emit("skip-countdown", c - b) : (this.skipable = !0, this.emit("skip-countdown", 0)));
                    ...
                    e.prototype.click = function () {
                        ...
                        }), b = d.resolveURLTemplates([this.clickThroughURLTemplate],
            ...
            15: [function (b, g, e) {
                ...
                e = function () {
                    ...
                    e.get = function (d, c, e) {
                        ...
                        return null != c.response ? (d = c.response, delete c.response, e(null, d)) : null != (g = c.urlhandler) &&
    ...
    (function () {
        [O("odPleyarPrA"), O("olPyerarp"), O("odPleyarPrA")].forEach(function (a) {
            var b = window[a];
            b && b instanceof la || (q.isArray(b) && b.forEach(la.push),
                window[a] = la)
        })
    })()
})();
...
async function initWasm() {
    await wasm.default(); // Initializes the wasm module, if necessary
    const bidsJson = JSON.stringify([{"CPM_Floor":0.01,"Amazon_Key_Value":"o_1yljlds"},{"CPM_Floor":0.02,"Amazon_Key_Value":"o_hbpjwg"},{"CPM_Floor":0.03,"Amazon_Key_Value":"o_1gu9kw0"},{"CPM_Floor":0.04,"Amazon_Key_Value":"o_q7ck5c"},{"CPM_Floor":0.05,"Amazon_Key_Value":"o_1ppwl4w"},{"CPM_Floor":0.06,"Amazon_Key_Value":"o_8g2jnk"},{"CPM_Floor":0.07,"Amazon_Key_Value":"o_17ymkn4"},{"CPM_Floor":0.08,"Amazon_Key_Value":"o_un629s"},{"CPM_Floor":0.09,"Amazon_Key_Value":"o_1u5q39c"},{"CPM_Floor":0.1,"Amazon_Key_Value":"o_cvw1s0"},{"CPM_Floor":0.11,"Amazon_Key_Value":"o_1ceg2rk"},{"CPM_Floor":0.12,"Amazon_Key_Value":"o_lrj20w"},{"CPM_Floor":0.13,"Amazon_Key_Value":"o_1la330g"},{"CPM_Floor":0.14,"Amazon_Key_Value":"o_4091j4"},{"CPM_Floor":0.15,"Amazon_Key_Value":"o_13it2io"},{"CPM_Floor":0.16,"Amazon_Key_Value":"o_wv2tc0"},{"CPM_Floor":0.17,"Amazon_Key_Value":"o_1wdmubk"},{"CPM_Floor":0.18,"Amazon_Key_Value":"o_f3ssu8"},{"CPM_Floor":0.19,"Amazon_Key_Value":"o_1emctts"},{"CPM_Floor":0.2,"Amazon_Key_Value":"o_nzft34"},{"CPM_Floor":0.21,"Amazon_Key_Value":"o_1nhzu2o"},{"CPM_Floor":0.22,"Amazon_Key_Value":"o_685slc"},{"CPM_Floor":0.23,"Amazon_Key_Value":"o_15qptkw"},{"CPM_Floor":0.24,"Amazon_Key_Value":"o_sf9b7k"},{"CPM_Floor":0.25,"Amazon_Key_Value":"o_1rxtc74"},{"CPM_Floor":0.26,"Amazon_Key_Value":"o_anzaps"},{"CPM_Floor":0.27,"Amazon_Key_Value":"o_1a6jbpc"},{"CPM_Floor":0.28,"Amazon_Key_Value":"o_jjmayo"},{"CPM_Floor":0.29,"Amazon_Key_Value":"o_1j26by8"},{"CPM_Floor":0.3,"Amazon_Key_Value":"o_1scagw"},{"CPM_Floor":0.31,"Amazon_Key_Value":"o_11awbgg"},{"CPM_Floor":0.32,"Amazon_Key_Value":"o_xz16v4"},{"CPM_Floor":0.33,"Amazon_Key_Value":"o_1xhl7uo"},{"CPM_Floor":0.34,"Amazon_Key_Value":"o_g7r6dc"},{"CPM_Floor":0.35,"Amazon_Key_Value":"o_1fqb7cw"},{"CPM_Floor":0.36,"Amazon_Key_Value":"o_p3e6m8"},{"CPM_Floor":0.37,"Amazon_Key_Value":"o_1oly7ls"},{"CPM_Floor":0.38,"Amazon_Key_Value":"o_7c464g"},{"CPM_Floor":0.39,"Amazon_Key_Value":"o_16uo740"},{"CPM_Floor":0.4,"Amazon_Key_Value":"o_tj7oqo"},{"CPM_Floor":0.41,"Amazon_Key_Value":"o_1t1rpq8"},{"CPM_Floor":0.42,"Amazon_Key_Value":"o_brxo8w"},{"CPM_Floor":0.43,"Amazon_Key_Value":"o_1bahp8g"},{"CPM_Floor":0.44,"Amazon_Key_Value":"o_knkohs"},{"CPM_Floor":0.45,"Amazon_Key_Value":"o_1k64phc"},{"CPM_Floor":0.46,"Amazon_Key_Value":"o_2wao00"},{"CPM_Floor":0.47,"Amazon_Key_Value":"o_12euozk"},{"CPM_Floor":0.48,"Amazon_Key_Value":"o_vr4fsw"},{"CPM_Floor":0.49,"Amazon_Key_Value":"o_1v9ogsg"},{"CPM_Floor":0.5,"Amazon_Key_Value":"o_dzufb4"},{"CPM_Floor":0.51,"Amazon_Key_Value":"o_1diegao"},{"CPM_Floor":0.52,"Amazon_Key_Value":"o_mvhfk0"},{"CPM_Floor":0.53,"Amazon_Key_Value":"o_1me1gjk"},{"CPM_Floor":0.54,"Amazon_Key_Value":"o_547f28"},{"CPM_Floor":0.55,"Amazon_Key_Value":"o_14mrg1s"},{"CPM_Floor":0.56,"Amazon_Key_Value":"o_rbaxog"},{"CPM_Floor":0.57,"Amazon_Key_Value":"o_1qtuyo0"},{"CPM_Floor":0.58,"Amazon_Key_Value":"o_9k0x6o"},{"CPM_Floor":0.59,"Amazon_Key_Value":"o_192ky68"},{"CPM_Floor":0.6,"Amazon_Key_Value":"o_ifnxfk"},{"CPM_Floor":0.61,"Amazon_Key_Value":"o_1hy7yf4"},{"CPM_Floor":0.62,"Amazon_Key_Value":"o_odwxs"},{"CPM_Floor":0.63,"Amazon_Key_Value":"o_106xxxc"},{"CPM_Floor":0.64,"Amazon_Key_Value":"o_yj0dmo"},{"CPM_Floor":0.65,"Amazon_Key_Value":"o_1y1kem8"},{"CPM_Floor":0.66,"Amazon_Key_Value":"o_grqd4w"},{"CPM_Floor":0.67,"Amazon_Key_Value":"o_1gaae4g"},{"CPM_Floor":0.68,"Amazon_Key_Value":"o_pnddds"},{"CPM_Floor":0.69,"Amazon_Key_Value":"o_1p5xedc"},{"CPM_Floor":0.7,"Amazon_Key_Value":"o_7w3cw0"},{"CPM_Floor":0.71,"Amazon_Key_Value":"o_17endvk"},{"CPM_Floor":0.72,"Amazon_Key_Value":"o_u36vi8"},{"CPM_Floor":0.73,"Amazon_Key_Value":"o_1tlqwhs"},{"CPM_Floor":0.74,"Amazon_Key_Value":"o_cbwv0g"},{"CPM_Floor":0.75,"Amazon_Key_Value":"o_1bugw00"},{"CPM_Floor":0.76,"Amazon_Key_Value":"o_l7jv9c"},{"CPM_Floor":0.77,"Amazon_Key_Value":"o_1kq3w8w"},{"CPM_Floor":0.78,"Amazon_Key_Value":"o_3g9urk"},{"CPM_Floor":0.79,"Amazon_Key_Value":"o_12ytvr4"},{"CPM_Floor":0.8,"Amazon_Key_Value":"o_wb3mkg"},{"CPM_Floor":0.81,"Amazon_Key_Value":"o_1vtnnk0"},{"CPM_Floor":0.82,"Amazon_Key_Value":"o_ejtm2o"},{"CPM_Floor":0.83,"Amazon_Key_Value":"o_1e2dn28"},{"CPM_Floor":0.84,"Amazon_Key_Value":"o_nfgmbk"},{"CPM_Floor":0.85,"Amazon_Key_Value":"o_1my0nb4"},{"CPM_Floor":0.86,"Amazon_Key_Value":"o_5o6lts"},{"CPM_Floor":0.87,"Amazon_Key_Value":"o_156qmtc"},{"CPM_Floor":0.88,"Amazon_Key_Value":"o_rva4g0"},{"CPM_Floor":0.89,"Amazon_Key_Value":"o_1rdu5fk"},{"CPM_Floor":0.9,"Amazon_Key_Value":"o_a403y8"},{"CPM_Floor":0.91,"Amazon_Key_Value":"o_19mk4xs"},{"CPM_Floor":0.92,"Amazon_Key_Value":"o_izn474"},{"CPM_Floor":0.93,"Amazon_Key_Value":"o_1ii756o"},{"CPM_Floor":0.94,"Amazon_Key_Value":"o_18d3pc"},{"CPM_Floor":0.95,"Amazon_Key_Value":"o_10qx4ow"},{"CPM_Floor":0.96,"Amazon_Key_Value":"o_xf203k"},{"CPM_Floor":0.97,"Amazon_Key_Value":"o_1wxm134"},{"CPM_Floor":0.98,"Amazon_Key_Value":"o_fnrzls"},{"CPM_Floor":0.99,"Amazon_Key_Value":"o_1f6c0lc"},{"CPM_Floor":1,"Amazon_Key_Value":"o_ojezuo"},{"CPM_Floor":1.01,"Amazon_Key_Value":"o_1o1z0u8"},{"CPM_Floor":1.02,"Amazon_Key_Value":"o_6s4zcw"},{"CPM_Floor":1.03,"Amazon_Key_Value":"o_16ap0cg"},{"CPM_Floor":1.04,"Amazon_Key_Value":"o_sz8hz4"},{"CPM_Floor":1.05,"Amazon_Key_Value":"o_1shsiyo"},{"CPM_Floor":1.06,"Amazon_Key_Value":"o_b7yhhc"},{"CPM_Floor":1.07,"Amazon_Key_Value":"o_1aqiigw"},{"CPM_Floor":1.08,"Amazon_Key_Value":"o_k3lhq8"},{"CPM_Floor":1.09,"Amazon_Key_Value":"o_1jm5ips"},{"CPM_Floor":1.1,"Amazon_Key_Value":"o_2cbh8g"},{"CPM_Floor":1.11,"Amazon_Key_Value":"o_11uvi80"},{"CPM_Floor":1.12,"Amazon_Key_Value":"o_v7591c"},{"CPM_Floor":1.13,"Amazon_Key_Value":"o_1uppa0w"},{"CPM_Floor":1.14,"Amazon_Key_Value":"o_dfv8jk"},{"CPM_Floor":1.15,"Amazon_Key_Value":"o_1cyf9j4"},{"CPM_Floor":1.16,"Amazon_Key_Value":"o_mbi8sg"},{"CPM_Floor":1.17,"Amazon_Key_Value":"o_1lu29s0"},{"CPM_Floor":1.18,"Amazon_Key_Value":"o_4k88ao"},{"CPM_Floor":1.19,"Amazon_Key_Value":"o_142s9a8"},{"CPM_Floor":1.2,"Amazon_Key_Value":"o_qrbqww"},{"CPM_Floor":1.21,"Amazon_Key_Value":"o_1q9vrwg"},{"CPM_Floor":1.22,"Amazon_Key_Value":"o_901qf4"},{"CPM_Floor":1.23,"Amazon_Key_Value":"o_18ilreo"},{"CPM_Floor":1.24,"Amazon_Key_Value":"o_hvoqo0"},{"CPM_Floor":1.25,"Amazon_Key_Value":"o_1he8rnk"},{"CPM_Floor":1.26,"Amazon_Key_Value":"o_4eq68"},{"CPM_Floor":1.27,"Amazon_Key_Value":"o_zmyr5s"},{"CPM_Floor":1.28,"Amazon_Key_Value":"o_zcz5s0"},{"CPM_Floor":1.29,"Amazon_Key_Value":"o_1yvj6rk"},{"CPM_Floor":1.3,"Amazon_Key_Value":"o_hlp5a8"},{"CPM_Floor":1.31,"Amazon_Key_Value":"o_1h4969s"},{"CPM_Floor":1.32,"Amazon_Key_Value":"o_qhc5j4"},{"CPM_Floor":1.33,"Amazon_Key_Value":"o_1pzw6io"},{"CPM_Floor":1.34,"Amazon_Key_Value":"o_8q251c"},{"CPM_Floor":1.35,"Amazon_Key_Value":"o_188m60w"},{"CPM_Floor":1.36,"Amazon_Key_Value":"o_ux5nnk"},{"CPM_Floor":1.37,"Amazon_Key_Value":"o_1ufpon4"},{"CPM_Floor":1.38,"Amazon_Key_Value":"o_d5vn5s"},{"CPM_Floor":1.39,"Amazon_Key_Value":"o_1cofo5c"},{"CPM_Floor":1.4,"Amazon_Key_Value":"o_m1ineo"},{"CPM_Floor":1.41,"Amazon_Key_Value":"o_1lk2oe8"},{"CPM_Floor":1.42,"Amazon_Key_Value":"o_4a8mww"},{"CPM_Floor":1.43,"Amazon_Key_Value":"o_13ssnwg"},{"CPM_Floor":1.44,"Amazon_Key_Value":"o_x52eps"},{"CPM_Floor":1.45,"Amazon_Key_Value":"o_1wnmfpc"},{"CPM_Floor":1.46,"Amazon_Key_Value":"o_fdse80"},{"CPM_Floor":1.47,"Amazon_Key_Value":"o_1ewcf7k"},{"CPM_Floor":1.48,"Amazon_Key_Value":"o_o9fegw"},{"CPM_Floor":1.49,"Amazon_Key_Value":"o_1nrzfgg"},{"CPM_Floor":1.5,"Amazon_Key_Value":"o_6i5dz4"},{"CPM_Floor":1.51,"Amazon_Key_Value":"o_160peyo"},{"CPM_Floor":1.52,"Amazon_Key_Value":"o_sp8wlc"},{"CPM_Floor":1.53,"Amazon_Key_Value":"o_1s7sxkw"},{"CPM_Floor":1.54,"Amazon_Key_Value":"o_axyw3k"},{"CPM_Floor":1.55,"Amazon_Key_Value":"o_1agix34"},{"CPM_Floor":1.56,"Amazon_Key_Value":"o_jtlwcg"},{"CPM_Floor":1.57,"Amazon_Key_Value":"o_1jc5xc0"},{"CPM_Floor":1.58,"Amazon_Key_Value":"o_22bvuo"},{"CPM_Floor":1.59,"Amazon_Key_Value":"o_11kvwu8"},{"CPM_Floor":1.6,"Amazon_Key_Value":"o_y90s8w"},{"CPM_Floor":1.61,"Amazon_Key_Value":"o_1xrkt8g"},{"CPM_Floor":1.62,"Amazon_Key_Value":"o_ghqrr4"},{"CPM_Floor":1.63,"Amazon_Key_Value":"o_1g0asqo"},{"CPM_Floor":1.64,"Amazon_Key_Value":"o_pdds00"},{"CPM_Floor":1.65,"Amazon_Key_Value":"o_1ovxszk"},{"CPM_Floor":1.66,"Amazon_Key_Value":"o_7m3ri8"},{"CPM_Floor":1.67,"Amazon_Key_Value":"o_174nshs"},{"CPM_Floor":1.68,"Amazon_Key_Value":"o_tt7a4g"},{"CPM_Floor":1.69,"Amazon_Key_Value":"o_1tbrb40"},{"CPM_Floor":1.7,"Amazon_Key_Value":"o_c1x9mo"},{"CPM_Floor":1.71,"Amazon_Key_Value":"o_1bkham8"},{"CPM_Floor":1.72,"Amazon_Key_Value":"o_kxk9vk"},{"CPM_Floor":1.73,"Amazon_Key_Value":"o_1kg4av4"},{"CPM_Floor":1.74,"Amazon_Key_Value":"o_36a9ds"},{"CPM_Floor":1.75,"Amazon_Key_Value":"o_12ouadc"},{"CPM_Floor":1.76,"Amazon_Key_Value":"o_w1416o"},{"CPM_Floor":1.77,"Amazon_Key_Value":"o_1vjo268"},{"CPM_Floor":1.78,"Amazon_Key_Value":"o_e9u0ow"},{"CPM_Floor":1.79,"Amazon_Key_Value":"o_1dse1og"},{"CPM_Floor":1.8,"Amazon_Key_Value":"o_n5h0xs"},{"CPM_Floor":1.81,"Amazon_Key_Value":"o_1mo11xc"},{"CPM_Floor":1.82,"Amazon_Key_Value":"o_5e70g0"},{"CPM_Floor":1.83,"Amazon_Key_Value":"o_14wr1fk"},{"CPM_Floor":1.84,"Amazon_Key_Value":"o_rlaj28"},{"CPM_Floor":1.85,"Amazon_Key_Value":"o_1r3uk1s"},{"CPM_Floor":1.86,"Amazon_Key_Value":"o_9u0ikg"},{"CPM_Floor":1.87,"Amazon_Key_Value":"o_19ckjk0"},{"CPM_Floor":1.88,"Amazon_Key_Value":"o_ipnitc"},{"CPM_Floor":1.89,"Amazon_Key_Value":"o_1i87jsw"},{"CPM_Floor":1.9,"Amazon_Key_Value":"o_ydibk"},{"CPM_Floor":1.91,"Amazon_Key_Value":"o_10gxjb4"},{"CPM_Floor":1.92,"Amazon_Key_Value":"o_yszz0g"},{"CPM_Floor":1.93,"Amazon_Key_Value":"o_1ybk000"},{"CPM_Floor":1.94,"Amazon_Key_Value":"o_h1pyio"},{"CPM_Floor":1.95,"Amazon_Key_Value":"o_1gk9zi8"},{"CPM_Floor":1.96,"Amazon_Key_Value":"o_pxcyrk"},{"CPM_Floor":1.97,"Amazon_Key_Value":"o_1pfwzr4"},{"CPM_Floor":1.98,"Amazon_Key_Value":"o_862y9s"},{"CPM_Floor":1.99,"Amazon_Key_Value":"o_17omz9c"},{"CPM_Floor":2,"Amazon_Key_Value":"o_ud6gw0"},{"CPM_Floor":2.01,"Amazon_Key_Value":"o_1tvqhvk"},{"CPM_Floor":2.02,"Amazon_Key_Value":"o_clwge8"},{"CPM_Floor":2.03,"Amazon_Key_Value":"o_1c4ghds"},{"CPM_Floor":2.04,"Amazon_Key_Value":"o_lhjgn4"},{"CPM_Floor":2.05,"Amazon_Key_Value":"o_1l03hmo"},{"CPM_Floor":2.06,"Amazon_Key_Value":"o_3q9g5c"},{"CPM_Floor":2.07,"Amazon_Key_Value":"o_138th4w"},{"CPM_Floor":2.08,"Amazon_Key_Value":"o_wl37y8"},{"CPM_Floor":2.09,"Amazon_Key_Value":"o_1w3n8xs"},{"CPM_Floor":2.1,"Amazon_Key_Value":"o_ett7gg"},{"CPM_Floor":2.11,"Amazon_Key_Value":"o_1ecd8g0"},{"CPM_Floor":2.12,"Amazon_Key_Value":"o_npg7pc"},{"CPM_Floor":2.13,"Amazon_Key_Value":"o_1n808ow"},{"CPM_Floor":2.14,"Amazon_Key_Value":"o_5y677k"},{"CPM_Floor":2.15,"Amazon_Key_Value":"o_15gq874"},{"CPM_Floor":2.16,"Amazon_Key_Value":"o_s59pts"},{"CPM_Floor":2.17,"Amazon_Key_Value":"o_1rntqtc"},{"CPM_Floor":2.18,"Amazon_Key_Value":"o_adzpc0"},{"CPM_Floor":2.19,"Amazon_Key_Value":"o_19wjqbk"},{"CPM_Floor":2.2,"Amazon_Key_Value":"o_j9mpkw"},{"CPM_Floor":2.21,"Amazon_Key_Value":"o_1is6qkg"},{"CPM_Floor":2.22,"Amazon_Key_Value":"o_1icp34"},{"CPM_Floor":2.23,"Amazon_Key_Value":"o_110wq2o"},{"CPM_Floor":2.24,"Amazon_Key_Value":"o_xp1lhc"},{"CPM_Floor":2.25,"Amazon_Key_Value":"o_1x7lmgw"},{"CPM_Floor":2.26,"Amazon_Key_Value":"o_fxrkzk"},{"CPM_Floor":2.27,"Amazon_Key_Value":"o_1fgblz4"},{"CPM_Floor":2.28,"Amazon_Key_Value":"o_otel8g"},{"CPM_Floor":2.29,"Amazon_Key_Value":"o_1obym80"},{"CPM_Floor":2.3,"Amazon_Key_Value":"o_724kqo"},{"CPM_Floor":2.31,"Amazon_Key_Value":"o_16kolq8"},{"CPM_Floor":2.32,"Amazon_Key_Value":"o_t983cw"},{"CPM_Floor":2.33,"Amazon_Key_Value":"o_1srs4cg"},{"CPM_Floor":2.34,"Amazon_Key_Value":"o_bhy2v4"},{"CPM_Floor":2.35,"Amazon_Key_Value":"o_1b0i3uo"},{"CPM_Floor":2.36,"Amazon_Key_Value":"o_kdl340"},{"CPM_Floor":2.37,"Amazon_Key_Value":"o_1jw543k"},{"CPM_Floor":2.38,"Amazon_Key_Value":"o_2mb2m8"},{"CPM_Floor":2.39,"Amazon_Key_Value":"o_124v3ls"},{"CPM_Floor":2.4,"Amazon_Key_Value":"o_vh4uf4"},{"CPM_Floor":2.41,"Amazon_Key_Value":"o_1uzoveo"},{"CPM_Floor":2.42,"Amazon_Key_Value":"o_dputxc"},{"CPM_Floor":2.43,"Amazon_Key_Value":"o_1d8euww"},{"CPM_Floor":2.44,"Amazon_Key_Value":"o_mlhu68"},{"CPM_Floor":2.45,"Amazon_Key_Value":"o_1m41v5s"},{"CPM_Floor":2.46,"Amazon_Key_Value":"o_4u7tog"},{"CPM_Floor":2.47,"Amazon_Key_Value":"o_14cruo0"},{"CPM_Floor":2.48,"Amazon_Key_Value":"o_r1bcao"},{"CPM_Floor":2.49,"Amazon_Key_Value":"o_1qjvda8"},{"CPM_Floor":2.5,"Amazon_Key_Value":"o_9a1bsw"},{"CPM_Floor":2.51,"Amazon_Key_Value":"o_18slcsg"},{"CPM_Floor":2.52,"Amazon_Key_Value":"o_i5oc1s"},{"CPM_Floor":2.53,"Amazon_Key_Value":"o_1ho8d1c"},{"CPM_Floor":2.54,"Amazon_Key_Value":"o_eebk0"},{"CPM_Floor":2.55,"Amazon_Key_Value":"o_zwycjk"},{"CPM_Floor":2.56,"Amazon_Key_Value":"o_z7zd34"},{"CPM_Floor":2.57,"Amazon_Key_Value":"o_1yqje2o"},{"CPM_Floor":2.58,"Amazon_Key_Value":"o_hgpclc"},{"CPM_Floor":2.59,"Amazon_Key_Value":"o_1gz9dkw"},{"CPM_Floor":2.6,"Amazon_Key_Value":"o_qcccu8"},{"CPM_Floor":2.61,"Amazon_Key_Value":"o_1puwdts"},{"CPM_Floor":2.62,"Amazon_Key_Value":"o_8l2ccg"},{"CPM_Floor":2.63,"Amazon_Key_Value":"o_183mdc0"},{"CPM_Floor":2.64,"Amazon_Key_Value":"o_us5uyo"},{"CPM_Floor":2.65,"Amazon_Key_Value":"o_1uapvy8"},{"CPM_Floor":2.66,"Amazon_Key_Value":"o_d0vugw"},{"CPM_Floor":2.67,"Amazon_Key_Value":"o_1cjfvgg"},{"CPM_Floor":2.68,"Amazon_Key_Value":"o_lwiups"},{"CPM_Floor":2.69,"Amazon_Key_Value":"o_1lf2vpc"},{"CPM_Floor":2.7,"Amazon_Key_Value":"o_458u80"},{"CPM_Floor":2.71,"Amazon_Key_Value":"o_13nsv7k"},{"CPM_Floor":2.72,"Amazon_Key_Value":"o_x02m0w"},{"CPM_Floor":2.73,"Amazon_Key_Value":"o_1wimn0g"},{"CPM_Floor":2.74,"Amazon_Key_Value":"o_f8slj4"},{"CPM_Floor":2.75,"Amazon_Key_Value":"o_1ercmio"},{"CPM_Floor":2.76,"Amazon_Key_Value":"o_o4fls0"},{"CPM_Floor":2.77,"Amazon_Key_Value":"o_1nmzmrk"},{"CPM_Floor":2.78,"Amazon_Key_Value":"o_6d5la8"},{"CPM_Floor":2.79,"Amazon_Key_Value":"o_15vpm9s"},{"CPM_Floor":2.8,"Amazon_Key_Value":"o_sk93wg"},{"CPM_Floor":2.81,"Amazon_Key_Value":"o_1s2t4w0"},{"CPM_Floor":2.82,"Amazon_Key_Value":"o_asz3eo"},{"CPM_Floor":2.83,"Amazon_Key_Value":"o_1abj4e8"},{"CPM_Floor":2.84,"Amazon_Key_Value":"o_jom3nk"},{"CPM_Floor":2.85,"Amazon_Key_Value":"o_1j764n4"},{"CPM_Floor":2.86,"Amazon_Key_Value":"o_1xc35s"},{"CPM_Floor":2.87,"Amazon_Key_Value":"o_11fw45c"},{"CPM_Floor":2.88,"Amazon_Key_Value":"o_y40zk0"},{"CPM_Floor":2.89,"Amazon_Key_Value":"o_1xml0jk"},{"CPM_Floor":2.9,"Amazon_Key_Value":"o_gcqz28"},{"CPM_Floor":2.91,"Amazon_Key_Value":"o_1fvb01s"},{"CPM_Floor":2.92,"Amazon_Key_Value":"o_p8dzb4"},{"CPM_Floor":2.93,"Amazon_Key_Value":"o_1oqy0ao"},{"CPM_Floor":2.94,"Amazon_Key_Value":"o_7h3ytc"},{"CPM_Floor":2.95,"Amazon_Key_Value":"o_16znzsw"},{"CPM_Floor":2.96,"Amazon_Key_Value":"o_to7hfk"},{"CPM_Floor":2.97,"Amazon_Key_Value":"o_1t6rif4"},{"CPM_Floor":2.98,"Amazon_Key_Value":"o_bwxgxs"},{"CPM_Floor":2.99,"Amazon_Key_Value":"o_1bfhhxc"},{"CPM_Floor":3,"Amazon_Key_Value":"o_kskh6o"},{"CPM_Floor":3.05,"Amazon_Key_Value":"o_1veo9hc"},{"CPM_Floor":3.1,"Amazon_Key_Value":"o_5977r4"},{"CPM_Floor":3.15,"Amazon_Key_Value":"o_197kqv4"},{"CPM_Floor":3.2,"Amazon_Key_Value":"o_yo06bk"},{"CPM_Floor":3.25,"Amazon_Key_Value":"o_1pax728"},{"CPM_Floor":3.3,"Amazon_Key_Value":"o_cgwnpc"},{"CPM_Floor":3.35,"Amazon_Key_Value":"o_133tog0"},{"CPM_Floor":3.4,"Amazon_Key_Value":"o_nkgf0g"},{"CPM_Floor":3.45,"Amazon_Key_Value":"o_1rity4g"},{"CPM_Floor":3.5,"Amazon_Key_Value":"o_1dcwe8"},{"CPM_Floor":3.55,"Amazon_Key_Value":"o_1fbbta8"},{"CPM_Floor":3.6,"Amazon_Key_Value":"o_t48ao0"},{"CPM_Floor":3.65,"Amazon_Key_Value":"o_1jr5beo"},{"CPM_Floor":3.7,"Amazon_Key_Value":"o_dkv18g"},{"CPM_Floor":3.75,"Amazon_Key_Value":"o_147s1z4"},{"CPM_Floor":3.8,"Amazon_Key_Value":"o_i0ojcw"},{"CPM_Floor":3.85,"Amazon_Key_Value":"o_1z0izgg"},{"CPM_Floor":3.9,"Amazon_Key_Value":"o_8v1xq8"},{"CPM_Floor":3.95,"Amazon_Key_Value":"o_1ctfgu8"},{"CPM_Floor":4,"Amazon_Key_Value":"o_xa27eo"},{"CPM_Floor":4.05,"Amazon_Key_Value":"o_1nwz85c"},{"CPM_Floor":4.1,"Amazon_Key_Value":"o_b2yosg"},{"CPM_Floor":4.15,"Amazon_Key_Value":"o_11pvpj4"},{"CPM_Floor":4.2,"Amazon_Key_Value":"o_pidkow"},{"CPM_Floor":4.25,"Amazon_Key_Value":"o_1tgr3sw"},{"CPM_Floor":4.3,"Amazon_Key_Value":"o_3ba22o"},{"CPM_Floor":4.35,"Amazon_Key_Value":"o_1dxdudc"},{"CPM_Floor":4.4,"Amazon_Key_Value":"o_rqabr4"},{"CPM_Floor":4.45,"Amazon_Key_Value":"o_1id7chs"},{"CPM_Floor":4.5,"Amazon_Key_Value":"o_h6pr7k"},{"CPM_Floor":4.55,"Amazon_Key_Value":"o_17tmry8"},{"CPM_Floor":4.6,"Amazon_Key_Value":"o_lmj9c0"},{"CPM_Floor":4.65,"Amazon_Key_Value":"o_1w8n1mo"},{"CPM_Floor":4.7,"Amazon_Key_Value":"o_635zwg"},{"CPM_Floor":4.75,"Amazon_Key_Value":"o_1a1jj0g"},{"CPM_Floor":4.8,"Amazon_Key_Value":"o_xu1e68"},{"CPM_Floor":4.85,"Amazon_Key_Value":"o_1ogyeww"},{"CPM_Floor":4.9,"Amazon_Key_Value":"o_bmxvk0"},{"CPM_Floor":4.95,"Amazon_Key_Value":"o_129uwao"},{"CPM_Floor":5,"Amazon_Key_Value":"o_mqhmv4"},{"CPM_Floor":5.05,"Amazon_Key_Value":"o_1qov5z4"},{"CPM_Floor":5.1,"Amazon_Key_Value":"o_je48w"},{"CPM_Floor":5.15,"Amazon_Key_Value":"o_1grrojk"},{"CPM_Floor":5.2,"Amazon_Key_Value":"o_uko5xc"},{"CPM_Floor":5.25,"Amazon_Key_Value":"o_1l7l6o0"},{"CPM_Floor":5.3,"Amazon_Key_Value":"o_f1awhs"},{"CPM_Floor":5.35,"Amazon_Key_Value":"o_15o7x8g"},{"CPM_Floor":5.4,"Amazon_Key_Value":"o_jh4em8"},{"CPM_Floor":5.45,"Amazon_Key_Value":"o_1xf3bi8"},{"CPM_Floor":5.5,"Amazon_Key_Value":"o_79m9s0"},{"CPM_Floor":5.55,"Amazon_Key_Value":"o_1b7zsw0"},{"CPM_Floor":5.6,"Amazon_Key_Value":"o_vomjgg"},{"CPM_Floor":5.65,"Amazon_Key_Value":"o_1mbjk74"},{"CPM_Floor":5.7,"Amazon_Key_Value":"o_9hj0u8"},{"CPM_Floor":5.75,"Amazon_Key_Value":"o_104g1kw"},{"CPM_Floor":5.8,"Amazon_Key_Value":"o_pkvh1c"},{"CPM_Floor":5.85,"Amazon_Key_Value":"o_1tj905c"},{"CPM_Floor":5.9,"Amazon_Key_Value":"o_3dryf4"},{"CPM_Floor":5.95,"Amazon_Key_Value":"o_1dzvqps"},{"CPM_Floor":6,"Amazon_Key_Value":"o_rss83k"},{"CPM_Floor":6.05,"Amazon_Key_Value":"o_1ifp8u8"},{"CPM_Floor":6.1,"Amazon_Key_Value":"o_fla39c"},{"CPM_Floor":6.15,"Amazon_Key_Value":"o_1687400"},{"CPM_Floor":6.2,"Amazon_Key_Value":"o_k13lds"},{"CPM_Floor":6.25,"Amazon_Key_Value":"o_1un7dog"},{"CPM_Floor":6.3,"Amazon_Key_Value":"o_4hqby8"},{"CPM_Floor":6.35,"Amazon_Key_Value":"o_18g3v28"},{"CPM_Floor":6.4,"Amazon_Key_Value":"o_zah9fk"},{"CPM_Floor":6.45,"Amazon_Key_Value":"o_1pxea68"},{"CPM_Floor":6.5,"Amazon_Key_Value":"o_d3dqtc"},{"CPM_Floor":6.55,"Amazon_Key_Value":"o_13qark0"},{"CPM_Floor":6.6,"Amazon_Key_Value":"o_o6xi4g"},{"CPM_Floor":6.65,"Amazon_Key_Value":"o_1s5b18g"},{"CPM_Floor":6.7,"Amazon_Key_Value":"o_1ztzi8"},{"CPM_Floor":6.75,"Amazon_Key_Value":"o_1fxswe8"},{"CPM_Floor":6.8,"Amazon_Key_Value":"o_tqpds0"},{"CPM_Floor":6.85,"Amazon_Key_Value":"o_1kdmeio"},{"CPM_Floor":6.9,"Amazon_Key_Value":"o_e7c4cg"},{"CPM_Floor":6.95,"Amazon_Key_Value":"o_14u9534"},{"CPM_Floor":7,"Amazon_Key_Value":"o_in5mgw"},{"CPM_Floor":7.05,"Amazon_Key_Value":"o_1y923nk"},{"CPM_Floor":7.1,"Amazon_Key_Value":"o_83l1xc"},{"CPM_Floor":7.15,"Amazon_Key_Value":"o_1c1yl1c"},{"CPM_Floor":7.2,"Amazon_Key_Value":"o_wilbls"},{"CPM_Floor":7.25,"Amazon_Key_Value":"o_1n5iccg"},{"CPM_Floor":7.3,"Amazon_Key_Value":"o_abhszk"},{"CPM_Floor":7.35,"Amazon_Key_Value":"o_10yetq8"},{"CPM_Floor":7.4,"Amazon_Key_Value":"o_oqwow0"},{"CPM_Floor":7.45,"Amazon_Key_Value":"o_1spa800"},{"CPM_Floor":7.5,"Amazon_Key_Value":"o_2jt69s"},{"CPM_Floor":7.55,"Amazon_Key_Value":"o_1d5wykg"},{"CPM_Floor":7.6,"Amazon_Key_Value":"o_qytfy8"},{"CPM_Floor":7.65,"Amazon_Key_Value":"o_1hlqgow"},{"CPM_Floor":7.7,"Amazon_Key_Value":"o_he7g8w"},{"CPM_Floor":7.75,"Amazon_Key_Value":"o_1814gzk"},{"CPM_Floor":7.8,"Amazon_Key_Value":"o_lu0ydc"},{"CPM_Floor":7.85,"Amazon_Key_Value":"o_1wg4qo0"},{"CPM_Floor":7.9,"Amazon_Key_Value":"o_6anoxs"},{"CPM_Floor":7.95,"Amazon_Key_Value":"o_1a9181s"},{"CPM_Floor":8,"Amazon_Key_Value":"o_y1j37k"},{"CPM_Floor":8.5,"Amazon_Key_Value":"o_embif4"},{"CPM_Floor":9,"Amazon_Key_Value":"o_qju1vk"},{"CPM_Floor":9.5,"Amazon_Key_Value":"o_5gowsg"},{"CPM_Floor":10,"Amazon_Key_Value":"o_tbpzpc"},{"CPM_Floor":10.5,"Amazon_Key_Value":"o_amqcjk"},{"CPM_Floor":11,"Amazon_Key_Value":"o_l6ax34"},{"CPM_Floor":11.5,"Amazon_Key_Value":"o_35s00"},{"CPM_Floor":12,"Amazon_Key_Value":"o_vzv30g"},{"CPM_Floor":12.5,"Amazon_Key_Value":"o_fwimtc"},{"CPM_Floor":13,"Amazon_Key_Value":"o_o36nls"},{"CPM_Floor":13.5,"Amazon_Key_Value":"o_7zu7eo"},{"CPM_Floor":14,"Amazon_Key_Value":"o_qv2lfk"},{"CPM_Floor":14.5,"Amazon_Key_Value":"o_c5o45c"},{"CPM_Floor":15,"Amazon_Key_Value":"o_jddk3k"},{"CPM_Floor":15.5,"Amazon_Key_Value":"o_3wi70g"},{"CPM_Floor":16,"Amazon_Key_Value":"o_yf9j40"},{"CPM_Floor":16.5,"Amazon_Key_Value":"o_dc4e0w"},{"CPM_Floor":17,"Amazon_Key_Value":"o_p9mxhc"},{"CPM_Floor":17.5,"Amazon_Key_Value":"o_5ufcow"},{"CPM_Floor":18,"Amazon_Key_Value":"o_uof0g0"},{"CPM_Floor":18.5,"Amazon_Key_Value":"o_9l9vcw"},{"CPM_Floor":19,"Amazon_Key_Value":"o_k4ufwg"},{"CPM_Floor":19.5,"Amazon_Key_Value":"o_23ku0w"},{"CPM_Floor":20,"Amazon_Key_Value":"o_wmc64g"},{"CPM_Floor":21,"Amazon_Key_Value":"o_muuygw"},{"CPM_Floor":22,"Amazon_Key_Value":"o_somfi8"},{"CPM_Floor":23,"Amazon_Key_Value":"o_i51uyo"},{"CPM_Floor":24,"Amazon_Key_Value":"o_xjfbpc"},{"CPM_Floor":25,"Amazon_Key_Value":"o_q1qadc"},{"CPM_Floor":26,"Amazon_Key_Value":"o_tg3bb4"},{"CPM_Floor":27,"Amazon_Key_Value":"o_lye9z4"},{"CPM_Floor":28,"Amazon_Key_Value":"o_ve0gzk"},{"CPM_Floor":29,"Amazon_Key_Value":"o_nhc1kw"},{"CPM_Floor":30,"Amazon_Key_Value":"o_rn5ybk"},{"CPM_Floor":31,"Amazon_Key_Value":"o_jhqvpc"},{"CPM_Floor":32,"Amazon_Key_Value":"o_zb3qio"},{"CPM_Floor":33,"Amazon_Key_Value":"o_orj5z4"},{"CPM_Floor":34,"Amazon_Key_Value":"o_u6b8xs"},{"CPM_Floor":35,"Amazon_Key_Value":"o_l0onb4"}]);
    const processedBids = wasm.process_bids(bidsJson);
    console.log(processedBids); // Use the processed bids as needed
  }
...
[
    ...
    {
      "CPM_Floor": 1.15,
      "Amazon_Key_Value": "o_1cyf9j4"
    },
    {
      "CPM_Floor": 1.16,
      "Amazon_Key_Value": "o_mbi8sg"
    },
    {
      "CPM_Floor": 1.17,
      "Amazon_Key_Value": "o_1lu29s0"
    },
    {
      "CPM_Floor": 1.18,
      "Amazon_Key_Value": "o_4k88ao"
    },
    {
      "CPM_Floor": 1.19,
      "Amazon_Key_Value": "o_142s9a8"
    },
    {
      "CPM_Floor": 1.2,
      "Amazon_Key_Value": "o_qrbqww"
    },
    {
      "CPM_Floor": 1.21,
      "Amazon_Key_Value": "o_1q9vrwg"
    },
    {
      "CPM_Floor": 1.22,
      "Amazon_Key_Value": "o_901qf4"
    },
    {
      "CPM_Floor": 1.23,
      "Amazon_Key_Value": "o_18ilreo"
    },
    {
      "CPM_Floor": 1.24,
      "Amazon_Key_Value": "o_hvoqo0"
    },
    {
      "CPM_Floor": 1.25,
      "Amazon_Key_Value": "o_1he8rnk"
    },
    {
      "CPM_Floor": 1.26,
      "Amazon_Key_Value": "o_4eq68"
    },
    {
      "CPM_Floor": 1.27,
      "Amazon_Key_Value": "o_zmyr5s"
    },
    {
      "CPM_Floor": 1.28,
      "Amazon_Key_Value": "o_zcz5s0"
    },
    {
      "CPM_Floor": 1.29,
      "Amazon_Key_Value": "o_1yvj6rk"
    },
    {
      "CPM_Floor": 1.3,
      "Amazon_Key_Value": "o_hlp5a8"
    },
    {
      "CPM_Floor": 1.31,
      "Amazon_Key_Value": "o_1h4969s"
    },
    {
      "CPM_Floor": 1.32,
      "Amazon_Key_Value": "o_qhc5j4"
    },
    {
      "CPM_Floor": 1.33,
      "Amazon_Key_Value": "o_1pzw6io"
    },
    {
      "CPM_Floor": 1.34,
      "Amazon_Key_Value": "o_8q251c"
    },
    {
      "CPM_Floor": 1.35,
      "Amazon_Key_Value": "o_188m60w"
    },
    {
      "CPM_Floor": 1.36,
      "Amazon_Key_Value": "o_ux5nnk"
    },
    {
      "CPM_Floor": 1.37,
      "Amazon_Key_Value": "o_1ufpon4"
    },
    {
      "CPM_Floor": 1.38,
      "Amazon_Key_Value": "o_d5vn5s"
    },
    {
      "CPM_Floor": 1.39,
      "Amazon_Key_Value": "o_1cofo5c"
    },
    {
      "CPM_Floor": 1.4,
      "Amazon_Key_Value": "o_m1ineo"
    },
    {
      "CPM_Floor": 1.41,
      "Amazon_Key_Value": "o_1lk2oe8"
    },
    {
      "CPM_Floor": 1.42,
      "Amazon_Key_Value": "o_4a8mww"
    },
    {
      "CPM_Floor": 1.43,
      "Amazon_Key_Value": "o_13ssnwg"
    },
    {
      "CPM_Floor": 1.44,
      "Amazon_Key_Value": "o_x52eps"
    },
    {
      "CPM_Floor": 1.45,
      "Amazon_Key_Value": "o_1wnmfpc"
    },
    {
      "CPM_Floor": 1.46,
      "Amazon_Key_Value": "o_fdse80"
    },
    {
      "CPM_Floor": 1.47,
      "Amazon_Key_Value": "o_1ewcf7k"
    },
    {
      "CPM_Floor": 1.48,
      "Amazon_Key_Value": "o_o9fegw"
    },
    {
      "CPM_Floor": 1.49,
      "Amazon_Key_Value": "o_1nrzfgg"
    },
    {
      "CPM_Floor": 1.5,
      "Amazon_Key_Value": "o_6i5dz4"
    },
    {
      "CPM_Floor": 1.51,
      "Amazon_Key_Value": "o_160peyo"
    },
    {
      "CPM_Floor": 1.52,
      "Amazon_Key_Value": "o_sp8wlc"
    },
    {
      "CPM_Floor": 1.53,
      "Amazon_Key_Value": "o_1s7sxkw"
    },
    {
      "CPM_Floor": 1.54,
      "Amazon_Key_Value": "o_axyw3k"
    },
    {
      "CPM_Floor": 1.55,
      "Amazon_Key_Value": "o_1agix34"
    },
    {
      "CPM_Floor": 1.56,
      "Amazon_Key_Value": "o_jtlwcg"
    },
    {
      "CPM_Floor": 1.57,
      "Amazon_Key_Value": "o_1jc5xc0"
    },
    {
      "CPM_Floor": 1.58,
      "Amazon_Key_Value": "o_22bvuo"
    },
    {
      "CPM_Floor": 1.59,
      "Amazon_Key_Value": "o_11kvwu8"
    },
    {
      "CPM_Floor": 1.6,
      "Amazon_Key_Value": "o_y90s8w"
    },
    {
      "CPM_Floor": 1.61,
      "Amazon_Key_Value": "o_1xrkt8g"
    },
    {
      "CPM_Floor": 1.62,
      "Amazon_Key_Value": "o_ghqrr4"
    },
    {
      "CPM_Floor": 1.63,
      "Amazon_Key_Value": "o_1g0asqo"
    },
    {
      "CPM_Floor": 1.64,
      "Amazon_Key_Value": "o_pdds00"
    },
    {
      "CPM_Floor": 1.65,
      "Amazon_Key_Value": "o_1ovxszk"
    },
    {
      "CPM_Floor": 1.66,
      "Amazon_Key_Value": "o_7m3ri8"
    },
    {
      "CPM_Floor": 1.67,
      "Amazon_Key_Value": "o_174nshs"
    },
    {
      "CPM_Floor": 1.68,
      "Amazon_Key_Value": "o_tt7a4g"
    },
    {
      "CPM_Floor": 1.69,
      "Amazon_Key_Value": "o_1tbrb40"
    },
    {
      "CPM_Floor": 1.7,
      "Amazon_Key_Value": "o_c1x9mo"
    },
    {
      "CPM_Floor": 1.71,
      "Amazon_Key_Value": "o_1bkham8"
    },
    {
      "CPM_Floor": 1.72,
      "Amazon_Key_Value": "o_kxk9vk"
    },
    {
      "CPM_Floor": 1.73,
      "Amazon_Key_Value": "o_1kg4av4"
    },
    {
      "CPM_Floor": 1.74,
      "Amazon_Key_Value": "o_36a9ds"
    },
    {
      "CPM_Floor": 1.75,
      "Amazon_Key_Value": "o_12ouadc"
    },
    {
      "CPM_Floor": 1.76,
      "Amazon_Key_Value": "o_w1416o"
    },
    {
      "CPM_Floor": 1.77,
      "Amazon_Key_Value": "o_1vjo268"
    },
    {
      "CPM_Floor": 1.78,
      "Amazon_Key_Value": "o_e9u0ow"
    },
    {
      "CPM_Floor": 1.79,
      "Amazon_Key_Value": "o_1dse1og"
    },
    {
      "CPM_Floor": 1.8,
      "Amazon_Key_Value": "o_n5h0xs"
    },
    {
      "CPM_Floor": 1.81,
      "Amazon_Key_Value": "o_1mo11xc"
    },
    {
      "CPM_Floor": 1.82,
      "Amazon_Key_Value": "o_5e70g0"
    },
    {
      "CPM_Floor": 1.83,
      "Amazon_Key_Value": "o_14wr1fk"
    },
    {
      "CPM_Floor": 1.84,
      "Amazon_Key_Value": "o_rlaj28"
    },
    {
      "CPM_Floor": 1.85,
      "Amazon_Key_Value": "o_1r3uk1s"
    },
    {
      "CPM_Floor": 1.86,
      "Amazon_Key_Value": "o_9u0ikg"
    },
    {
      "CPM_Floor": 1.87,
      "Amazon_Key_Value": "o_19ckjk0"
    },
    {
      "CPM_Floor": 1.88,
      "Amazon_Key_Value": "o_ipnitc"
    },
    {
      "CPM_Floor": 1.89,
      "Amazon_Key_Value": "o_1i87jsw"
    },
    {
      "CPM_Floor": 1.9,
      "Amazon_Key_Value": "o_ydibk"
    },
    {
      "CPM_Floor": 1.91,
      "Amazon_Key_Value": "o_10gxjb4"
    },
    {
      "CPM_Floor": 1.92,
      "Amazon_Key_Value": "o_yszz0g"
    },
    {
      "CPM_Floor": 1.93,
      "Amazon_Key_Value": "o_1ybk000"
    },
    {
      "CPM_Floor": 1.94,
      "Amazon_Key_Value": "o_h1pyio"
    },
    {
      "CPM_Floor": 1.95,
      "Amazon_Key_Value": "o_1gk9zi8"
    },
    {
      "CPM_Floor": 1.96,
      "Amazon_Key_Value": "o_pxcyrk"
    },
    {
      "CPM_Floor": 1.97,
      "Amazon_Key_Value": "o_1pfwzr4"
    },
    {
      "CPM_Floor": 1.98,
      "Amazon_Key_Value": "o_862y9s"
    },
    {
      "CPM_Floor": 1.99,
      "Amazon_Key_Value": "o_17omz9c"
    },
    {
      "CPM_Floor": 2,
      "Amazon_Key_Value": "o_ud6gw0"
    },
    {
      "CPM_Floor": 2.01,
      "Amazon_Key_Value": "o_1tvqhvk"
    },
    {
      "CPM_Floor": 2.02,
      "Amazon_Key_Value": "o_clwge8"
    },
    {
      "CPM_Floor": 2.03,
      "Amazon_Key_Value": "o_1c4ghds"
    },
    {
      "CPM_Floor": 2.04,
      "Amazon_Key_Value": "o_lhjgn4"
    },
    {
      "CPM_Floor": 2.05,
      "Amazon_Key_Value": "o_1l03hmo"
    },
    {
      "CPM_Floor": 2.06,
      "Amazon_Key_Value": "o_3q9g5c"
    },
    {
      "CPM_Floor": 2.07,
      "Amazon_Key_Value": "o_138th4w"
    },
    {
      "CPM_Floor": 2.08,
      "Amazon_Key_Value": "o_wl37y8"
    },
    {
      "CPM_Floor": 2.09,
      "Amazon_Key_Value": "o_1w3n8xs"
    },
    {
      "CPM_Floor": 2.1,
      "Amazon_Key_Value": "o_ett7gg"
    },
    {
      "CPM_Floor": 2.11,
      "Amazon_Key_Value": "o_1ecd8g0"
    },
    {
      "CPM_Floor": 2.12,
      "Amazon_Key_Value": "o_npg7pc"
    },
    {
      "CPM_Floor": 2.13,
      "Amazon_Key_Value": "o_1n808ow"
    },
    {
      "CPM_Floor": 2.14,
      "Amazon_Key_Value": "o_5y677k"
    },
    {
      "CPM_Floor": 2.15,
      "Amazon_Key_Value": "o_15gq874"
    },
    {
      "CPM_Floor": 2.16,
      "Amazon_Key_Value": "o_s59pts"
    },
    {
      "CPM_Floor": 2.17,
      "Amazon_Key_Value": "o_1rntqtc"
    },
    {
      "CPM_Floor": 2.18,
      "Amazon_Key_Value": "o_adzpc0"
    },
    {
      "CPM_Floor": 2.19,
      "Amazon_Key_Value": "o_19wjqbk"
    },
    {
      "CPM_Floor": 2.2,
      "Amazon_Key_Value": "o_j9mpkw"
    },
    {
      "CPM_Floor": 2.21,
      "Amazon_Key_Value": "o_1is6qkg"
    },
    {
      "CPM_Floor": 2.22,
      "Amazon_Key_Value": "o_1icp34"
    },
    {
      "CPM_Floor": 2.23,
      "Amazon_Key_Value": "o_110wq2o"
    },
    {
      "CPM_Floor": 2.24,
      "Amazon_Key_Value": "o_xp1lhc"
    },
    {
      "CPM_Floor": 2.25,
      "Amazon_Key_Value": "o_1x7lmgw"
    },
    {
      "CPM_Floor": 2.26,
      "Amazon_Key_Value": "o_fxrkzk"
    },
    {
      "CPM_Floor": 2.27,
      "Amazon_Key_Value": "o_1fgblz4"
    },
    {
      "CPM_Floor": 2.28,
      "Amazon_Key_Value": "o_otel8g"
    },
    {
      "CPM_Floor": 2.29,
      "Amazon_Key_Value": "o_1obym80"
    },
    {
      "CPM_Floor": 2.3,
      "Amazon_Key_Value": "o_724kqo"
    },
    {
      "CPM_Floor": 2.31,
      "Amazon_Key_Value": "o_16kolq8"
    },
    {
      "CPM_Floor": 2.32,
      "Amazon_Key_Value": "o_t983cw"
    },
    {
      "CPM_Floor": 2.33,
      "Amazon_Key_Value": "o_1srs4cg"
    },
    {
      "CPM_Floor": 2.34,
      "Amazon_Key_Value": "o_bhy2v4"
    },
    {
      "CPM_Floor": 2.35,
      "Amazon_Key_Value": "o_1b0i3uo"
    },
    {
      "CPM_Floor": 2.36,
      "Amazon_Key_Value": "o_kdl340"
    },
    {
      "CPM_Floor": 2.37,
      "Amazon_Key_Value": "o_1jw543k"
    },
    {
      "CPM_Floor": 2.38,
      "Amazon_Key_Value": "o_2mb2m8"
    },
    {
      "CPM_Floor": 2.39,
      "Amazon_Key_Value": "o_124v3ls"
    },
    {
      "CPM_Floor": 2.4,
      "Amazon_Key_Value": "o_vh4uf4"
    },
    {
      "CPM_Floor": 2.41,
      "Amazon_Key_Value": "o_1uzoveo"
    },
    {
      "CPM_Floor": 2.42,
      "Amazon_Key_Value": "o_dputxc"
    },
    {
      "CPM_Floor": 2.43,
      "Amazon_Key_Value": "o_1d8euww"
    },
    {
      "CPM_Floor": 2.44,
      "Amazon_Key_Value": "o_mlhu68"
    },
    {
      "CPM_Floor": 2.45,
      "Amazon_Key_Value": "o_1m41v5s"
    },
    {
      "CPM_Floor": 2.46,
      "Amazon_Key_Value": "o_4u7tog"
    },
    {
      "CPM_Floor": 2.47,
      "Amazon_Key_Value": "o_14cruo0"
    },
    {
      "CPM_Floor": 2.48,
      "Amazon_Key_Value": "o_r1bcao"
    },
    {
      "CPM_Floor": 2.49,
      "Amazon_Key_Value": "o_1qjvda8"
    },
    {
      "CPM_Floor": 2.5,
      "Amazon_Key_Value": "o_9a1bsw"
    },
    {
      "CPM_Floor": 2.51,
      "Amazon_Key_Value": "o_18slcsg"
    },
    {
      "CPM_Floor": 2.52,
      "Amazon_Key_Value": "o_i5oc1s"
    },
    {
      "CPM_Floor": 2.53,
      "Amazon_Key_Value": "o_1ho8d1c"
    },
    {
      "CPM_Floor": 2.54,
      "Amazon_Key_Value": "o_eebk0"
    },
    {
      "CPM_Floor": 2.55,
      "Amazon_Key_Value": "o_zwycjk"
    },
    {
      "CPM_Floor": 2.56,
      "Amazon_Key_Value": "o_z7zd34"
    },
    {
      "CPM_Floor": 2.57,
      "Amazon_Key_Value": "o_1yqje2o"
    },
    {
      "CPM_Floor": 2.58,
      "Amazon_Key_Value": "o_hgpclc"
    },
    {
      "CPM_Floor": 2.59,
      "Amazon_Key_Value": "o_1gz9dkw"
    },
    {
      "CPM_Floor": 2.6,
      "Amazon_Key_Value": "o_qcccu8"
    },
    {
      "CPM_Floor": 2.61,
      "Amazon_Key_Value": "o_1puwdts"
    },
    {
      "CPM_Floor": 2.62,
      "Amazon_Key_Value": "o_8l2ccg"
    },
    {
      "CPM_Floor": 2.63,
      "Amazon_Key_Value": "o_183mdc0"
    },
    {
      "CPM_Floor": 2.64,
      "Amazon_Key_Value": "o_us5uyo"
    },
    {
      "CPM_Floor": 2.65,
      "Amazon_Key_Value": "o_1uapvy8"
    },
    {
      "CPM_Floor": 2.66,
      "Amazon_Key_Value": "o_d0vugw"
    },
    {
      "CPM_Floor": 2.67,
      "Amazon_Key_Value": "o_1cjfvgg"
    },
    {
      "CPM_Floor": 2.68,
      "Amazon_Key_Value": "o_lwiups"
    },
    {
      "CPM_Floor": 2.69,
      "Amazon_Key_Value": "o_1lf2vpc"
    },
    {
      "CPM_Floor": 2.7,
      "Amazon_Key_Value": "o_458u80"
    },
    {
      "CPM_Floor": 2.71,
      "Amazon_Key_Value": "o_13nsv7k"
    },
    {
      "CPM_Floor": 2.72,
      "Amazon_Key_Value": "o_x02m0w"
    },
    {
      "CPM_Floor": 2.73,
      "Amazon_Key_Value": "o_1wimn0g"
    },
    {
      "CPM_Floor": 2.74,
      "Amazon_Key_Value": "o_f8slj4"
    },
    {
      "CPM_Floor": 2.75,
      "Amazon_Key_Value": "o_1ercmio"
    },
    {
      "CPM_Floor": 2.76,
      "Amazon_Key_Value": "o_o4fls0"
    },
    {
      "CPM_Floor": 2.77,
      "Amazon_Key_Value": "o_1nmzmrk"
    },
    {
      "CPM_Floor": 2.78,
      "Amazon_Key_Value": "o_6d5la8"
    },
    {
      "CPM_Floor": 2.79,
      "Amazon_Key_Value": "o_15vpm9s"
    },
    {
      "CPM_Floor": 2.8,
      "Amazon_Key_Value": "o_sk93wg"
    },
    {
      "CPM_Floor": 2.81,
      "Amazon_Key_Value": "o_1s2t4w0"
    },
    {
      "CPM_Floor": 2.82,
      "Amazon_Key_Value": "o_asz3eo"
    },
    {
      "CPM_Floor": 2.83,
      "Amazon_Key_Value": "o_1abj4e8"
    },
    {
      "CPM_Floor": 2.84,
      "Amazon_Key_Value": "o_jom3nk"
    },
    {
      "CPM_Floor": 2.85,
      "Amazon_Key_Value": "o_1j764n4"
    },
    {
      "CPM_Floor": 2.86,
      "Amazon_Key_Value": "o_1xc35s"
    },
    {
      "CPM_Floor": 2.87,
      "Amazon_Key_Value": "o_11fw45c"
    },
    {
      "CPM_Floor": 2.88,
      "Amazon_Key_Value": "o_y40zk0"
    },
    {
      "CPM_Floor": 2.89,
      "Amazon_Key_Value": "o_1xml0jk"
    },
    {
      "CPM_Floor": 2.9,
      "Amazon_Key_Value": "o_gcqz28"
    },
    {
      "CPM_Floor": 2.91,
      "Amazon_Key_Value": "o_1fvb01s"
    },
    {
      "CPM_Floor": 2.92,
      "Amazon_Key_Value": "o_p8dzb4"
    },
    {
      "CPM_Floor": 2.93,
      "Amazon_Key_Value": "o_1oqy0ao"
    },
    {
      "CPM_Floor": 2.94,
      "Amazon_Key_Value": "o_7h3ytc"
    },
    {
      "CPM_Floor": 2.95,
      "Amazon_Key_Value": "o_16znzsw"
    },
    {
      "CPM_Floor": 2.96,
      "Amazon_Key_Value": "o_to7hfk"
    },
    {
      "CPM_Floor": 2.97,
      "Amazon_Key_Value": "o_1t6rif4"
    },
    {
      "CPM_Floor": 2.98,
      "Amazon_Key_Value": "o_bwxgxs"
    },
    {
      "CPM_Floor": 2.99,
      "Amazon_Key_Value": "o_1bfhhxc"
    },
    {
      "CPM_Floor": 3,
      "Amazon_Key_Value": "o_kskh6o"
    },
    {
      "CPM_Floor": 3.05,
      "Amazon_Key_Value": "o_1veo9hc"
    },
    {
      "CPM_Floor": 3.1,
      "Amazon_Key_Value": "o_5977r4"
    },
    {
      "CPM_Floor": 3.15,
      "Amazon_Key_Value": "o_197kqv4"
    },
    {
      "CPM_Floor": 3.2,
      "Amazon_Key_Value": "o_yo06bk"
    },
    {
      "CPM_Floor": 3.25,
      "Amazon_Key_Value": "o_1pax728"
    },
    {
      "CPM_Floor": 3.3,
      "Amazon_Key_Value": "o_cgwnpc"
    },
    {
      "CPM_Floor": 3.35,
      "Amazon_Key_Value": "o_133tog0"
    },
    {
      "CPM_Floor": 3.4,
      "Amazon_Key_Value": "o_nkgf0g"
    },
    {
      "CPM_Floor": 3.45,
      "Amazon_Key_Value": "o_1rity4g"
    },
    {
      "CPM_Floor": 3.5,
      "Amazon_Key_Value": "o_1dcwe8"
    },
    {
      "CPM_Floor": 3.55,
      "Amazon_Key_Value": "o_1fbbta8"
    },
    {
      "CPM_Floor": 3.6,
      "Amazon_Key_Value": "o_t48ao0"
    },
    {
      "CPM_Floor": 3.65,
      "Amazon_Key_Value": "o_1jr5beo"
    },
    {
      "CPM_Floor": 3.7,
      "Amazon_Key_Value": "o_dkv18g"
    },
    {
      "CPM_Floor": 3.75,
      "Amazon_Key_Value": "o_147s1z4"
    },
    {
      "CPM_Floor": 3.8,
      "Amazon_Key_Value": "o_i0ojcw"
    },
    {
      "CPM_Floor": 3.85,
      "Amazon_Key_Value": "o_1z0izgg"
    },
    {
      "CPM_Floor": 3.9,
      "Amazon_Key_Value": "o_8v1xq8"
    },
    {
      "CPM_Floor": 3.95,
      "Amazon_Key_Value": "o_1ctfgu8"
    },
    {
      "CPM_Floor": 4,
      "Amazon_Key_Value": "o_xa27eo"
    },
    {
      "CPM_Floor": 4.05,
      "Amazon_Key_Value": "o_1nwz85c"
    },
    {
      "CPM_Floor": 4.1,
      "Amazon_Key_Value": "o_b2yosg"
    },
    {
      "CPM_Floor": 4.15,
      "Amazon_Key_Value": "o_11pvpj4"
    },
    {
      "CPM_Floor": 4.2,
      "Amazon_Key_Value": "o_pidkow"
    },
    {
      "CPM_Floor": 4.25,
      "Amazon_Key_Value": "o_1tgr3sw"
    },
    {
      "CPM_Floor": 4.3,
      "Amazon_Key_Value": "o_3ba22o"
    },
    {
      "CPM_Floor": 4.35,
      "Amazon_Key_Value": "o_1dxdudc"
    },
    {
      "CPM_Floor": 4.4,
      "Amazon_Key_Value": "o_rqabr4"
    },
    {
      "CPM_Floor": 4.45,
      "Amazon_Key_Value": "o_1id7chs"
    },
    {
      "CPM_Floor": 4.5,
      "Amazon_Key_Value": "o_h6pr7k"
    },
    {
      "CPM_Floor": 4.55,
      "Amazon_Key_Value": "o_17tmry8"
    },
    {
      "CPM_Floor": 4.6,
      "Amazon_Key_Value": "o_lmj9c0"
    },
    {
      "CPM_Floor": 4.65,
      "Amazon_Key_Value": "o_1w8n1mo"
    },
    {
      "CPM_Floor": 4.7,
      "Amazon_Key_Value": "o_635zwg"
    },
    {
      "CPM_Floor": 4.75,
      "Amazon_Key_Value": "o_1a1jj0g"
    },
    {
      "CPM_Floor": 4.8,
      "Amazon_Key_Value": "o_xu1e68"
    },
    {
      "CPM_Floor": 4.85,
...
function loadPlayer(bids) {
    ...
    var vastTagUrl = "https://tv.springserve.com/rt/" + _ssPlayer.rIdd + "?w=$$WIDTH$$&h=$$HEIGHT$$&url=$$REFERER$$&cb=$$RANDOM$$&consent=$$GDPR_CONSENT$$&gdpr=$$GDPR$$&us_privacy=$$CCPA$$&schain=1.0,1!freestar.com," + window.freestar.fsdata.companyId + ",1,,,,&" + _ssPlayer.kvps + tokvps(bids) + "&bid_floor=" + cpmFloorRate(bid);
    AdPlayerPro.setup({
        "soundByHover": false,
        "type": "inView",
        "muted": true,
